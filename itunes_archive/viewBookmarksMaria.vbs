...
Set File_Name = newFS.OpenTextFile("C:\\xampp\\htdocs\\maria.htm", 2, True)
...
File_Name.WriteLine "<script> function confirmDelete() {  if (confirm(""Are you sure you want to clear your bookmarks?"")) { window.location = '/scripts/deleteBookmarksMaria.php';  }}</script>"
