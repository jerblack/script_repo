...
(function (f, m) {
    ...
    function w(a) {
        if (!Ga[a]) {
            var o = s.body, b = c("<" + a + ">").appendTo(o), q = b.css("display");
            b.remove();
            if ("none" === q || "" === q) {
    ...
    function x(a, o, b, q) {
        ...
        }); else if (!b && null != o && "object" == typeof o)for (var e in o)x(a + "[" + e + "]", o[e], b, q); else q(a,
            o)
    }
    ...
    function k(a) {
        return function (o, b) {
            ...
            if (c.isFunction(b))for (var e = o.toLowerCase().split(Ia),
                                         g = 0, A = e.length, d, f; g < A; g++)d = e[g], (f = /^\+/.test(d)) && (d = d.substr(1) || "*"), d = a[d] = a[d] || [], d[f ? "unshift" : "push"](b)
        }
    }

    function d(a, o, b) {
        var e = "width" === o ? a.offsetWidth : a.offsetHeight, g = "width" === o ? Wa : Xa, A = 0, d = g.length;
        if (0 < e) {
            if ("border" !== b)for (; A < d; A++)b || (e -= parseFloat(c.css(a, "padding" + g[A])) || 0), "margin" === b ? e += parseFloat(c.css(a, b + g[A])) || 0 : e -= parseFloat(c.css(a, "border" + g[A] + "Width")) || 0;
            return e + "px"
        }
        e = pa(a, o, o);
        if (0 > e || null == e)e = a.style[o] || 0;
        e = parseFloat(e) || 0;
        if (b)for (; A < d; A++)e += parseFloat(c.css(a,
    ...
    function J(a, o) {
        ...
        if (1 === o.nodeType) {
            ...
            if ("object" === b)o.outerHTML = a.outerHTML; else if ("input" !== b || "checkbox" !== a.type && "radio" !== a.type)if ("option" ===
                b)o.selected = a.defaultSelected; else {
    ...
    function z(a, o) {
        if (1 === o.nodeType && c.hasData(a)) {
            var b, e, g;
            e = c._data(a);
            var A = c._data(o, e), d = e.events;
            if (d)for (b in delete A.handle, A.events = {}, d) {
                e = 0;
    ...
    function E(a) {
        var c = Ya.split("|"), a = a.createDocumentFragment();
    ...
    function F(a, o, b) {
        var e = o + "defer", g = o + "queue", A = o + "mark", d = c._data(a, e);
    ...
    function R(a) {
        for (var o in a)if (!("data" === o && c.isEmptyObject(a[o])) && "toJSON" !== o)return !1;
        return !0
    }

    function ca(a, o, b) {
        if (b === m && 1 === a.nodeType)if (b = "data-" + o.replace(da, "-$1").toLowerCase(), b = a.getAttribute(b), "string" == typeof b) {
            try {
                b = "true" === b ? !0 : "false" ===
    ...
    function V(a) {
        var c = L[a] = {}, b, e, a = a.split(/\s+/);
        b = 0;
        for (e = a.length; b < e; b++)c[a[b]] = !0;
        return c
    }

    var s = f.document, $ = f.navigator, T = f.location, c = function () {
        function a() {
            if (!c.isReady) {
                try {
        ...
        var c = function (a, b) {
            ...
            }, b = f.jQuery, e = f.$, g, A = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, d = /\S/,
            h = /^\s+/, i = /\s+$/, k = /^<(\w+)\s*\/?>(?:<\/\1>)?$/, n = /^[\],:{}\s]*$/, l = /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, j = /"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, p = /(?:^|:|,)(?:\s*\[)+/g, r = /(webkit)[ \/]([\w.]+)/, t = /(opera)(?:.*version)?[ \/]([\w.]+)/, G = /(msie) ([\w.]+)/, O = /(mozilla)(?:.*? rv:([\w.]+))?/, x = /-([a-z]|[0-9])/ig, B = /^-ms-/, H = function (a, c) {
                return (c + "").toUpperCase()
            }, v = $.userAgent, ka, Ca, Qb = Object.prototype.toString, sb = Object.prototype.hasOwnProperty, tb = Array.prototype.push,
            Ka = Array.prototype.slice, E = String.prototype.trim, Nb = Array.prototype.indexOf, Ob = {};
        c.fn = c.prototype = {
            constructor: c, init: function (a, b, e) {
                var u, q;
                if (!a)return this;
            ...
            }, push: tb, sort: [].sort, splice: [].splice
        };
        c.fn.init.prototype = c.fn;
        c.extend = c.fn.extend = function () {
            var a, b, e, u, q, g, I = arguments[0] || {}, A = 1, d = arguments.length, f = !1;
            "boolean" == typeof I && (f = I, I = arguments[1] || {}, A = 2);
            "object" != typeof I && !c.isFunction(I) && (I = {});
            for (d === A && (I = this, --A); A < d; A++)if (null != (a = arguments[A]))for (b in a)e = I[b], u = a[b], I !== u && (f && u && (c.isPlainObject(u) || (q = c.isArray(u))) ? (q ? (q = !1, g = e && c.isArray(e) ? e : []) : g = e && c.isPlainObject(e) ? e : {}, I[b] = c.extend(f, g, u)) : u !== m && (I[b] = u));
            return I
        };
        c.extend({
            noConflict: function (a) {
                ...
                if (!ka) {
                    ...
                    if (s.addEventListener)s.addEventListener("DOMContentLoaded",
                        Ca, !1), f.addEventListener("load", c.ready, !1); else if (s.attachEvent) {
                ...
                var u, q = 0, g = a.length, I = g === m || c.isFunction(a);
                if (e)if (I)for (u in a) {
                    if (!1 === b.apply(a[u], e))break
                } else for (; q < g && !1 !== b.apply(a[q++], e);); else if (I)for (u in a) {
                    if (!1 === b.call(a[u], u, a[u]))break
                } else for (; q < g && !1 !== b.call(a[q], q, a[q++]););
                return a
            }, trim: E ? function (a) {
                ...
                if (c) {
                    ...
                    b = c.length;
                    for (o = o ? 0 > o ? Math.max(0, b + o) : o : 0; o < b; o++)if (o in c && c[o] === a)return o
                }
                return -1
            }, merge: function (a, c) {
                var o = a.length, b = 0;
                if ("number" == typeof c.length)for (var e = c.length; b < e; b++)a[o++] = c[b]; else for (; c[b] !== m;)a[o++] =
                    c[b++];
                a.length = o;
                return a
            }, grep: function (a, c, o) {
                ...
                var u, q, g = [], I = 0, A = a.length;
                if (a instanceof c || A !== m && "number" == typeof A && (0 < A && a[0] && a[A - 1] || 0 === A || c.isArray(a)))for (; I < A; I++)u = b(a[I], I, e), null != u && (g[g.length] = u); else for (q in a)u = b(a[q], q, e), null != u && (g[g.length] = u);
                return g.concat.apply([], g)
            }, guid: 1, proxy: function (a, b) {
                if ("string" == typeof b)var e = a[b], b = a, a = e;
                if (!c.isFunction(a))return m;
                var u = Ka.call(arguments, 2), e = function () {
    ...
    c.Callbacks = function (a) {
        var a = a ? L[a] || V(a) : {}, o = [], b = [], e, g, A, d, f, h = function (b) {
            var e, u, q, g;
            e = 0;
            for (u = b.length; e <
            ...
            f = A || 0;
            A = 0;
            for (d = o.length; o && f < d; f++)if (!1 === o[f].apply(c, h) && a.stopOnFalse) {
                e = !0;
                break
            }
            g = !1;
            ...
            add: function () {
                ...
                if (o)for (var c = arguments, b = 0, e = c.length; b < e; b++)for (var u =
                    0; u < o.length && !(c[b] === o[u] && (g && u <= d && (d--, u <= f && f--), o.splice(u--, 1), a.unique)); u++);
                return this
            }, has: function (a) {
                if (o)for (var c = 0, b = o.length; c < b; c++)if (a === o[c])return !0;
                return !1
            }, empty: function () {
                o = [];
                return this
    ...
    c.extend({
        Deferred: function (a) {
            var b = c.Callbacks("once memory"), e = c.Callbacks("once memory"), q = c.Callbacks("memory"), g = "pending", A = {
                resolve: b,
                reject: e,
                notify: q
            }, d = {
                done: b.add, fail: e.add, progress: q.add, state: function () {
                    return g
                }, isResolved: b.fired, isRejected: e.fired, then: function (a, c, b) {
                    ...
                    return c.Deferred(function (e) {
                        c.each({
                                ...
                                "resolve"], fail: [b, "reject"], progress: [o, "notify"]
                        }, function (a, b) {
                            var o = b[0], u = b[1], q;
                    ...
                    if (null == a)a = d; else for (var c in d)a[c] = d[c];
                    return a
                }
            }, f = d.promise({}), h;
            ...
            var q = M.call(arguments, 0), g = 0, A = q.length, d = Array(A), f = A, h = 1 >= A && a && c.isFunction(a.promise) ? a : c.Deferred(), i = h.promise();
            if (1 < A) {
    ...
    c.support = function () {
        ...
        e.appendChild(k);
        k.innerHTML = "";
        f.getComputedStyle && (A = s.createElement("div"), A.style.width = "0", A.style.marginRight = "0", k.style.width = "2px", k.appendChild(A), a.reliableMarginRight = 0 === (parseInt((f.getComputedStyle(A, null) || {marginRight: 0}).marginRight, 10) || 0));
        if (k.attachEvent)for (h in{
            submit: 1,
            change: 1, focusin: 1
    ...
    c.extend({
        ...
        data: function (a, b, e, q) {
            if (c.acceptData(a)) {
                var g, A;
                g = c.expando;
                var d = "string" == typeof b, f = a.nodeType, h = f ? c.cache : a, i = f ? a[g] : a[g] && g, k = "events" === b;
        ...
        removeData: function (a, b, e) {
            if (c.acceptData(a)) {
                var q, g, A, d = c.expando, f = a.nodeType, h = f ? c.cache : a, i = f ? a[d] : d;
                if (h[i]) {
    ...
    c.extend({
        _mark: function (a, b) {
            ...
            var b = b || "fx", e = c.queue(a, b), q = e.shift(), g = {};
    ...
    c.fn.extend({
        queue: function (a, b) {
            ...
            "string" != typeof a && (a = m);
            for (var a = a || "fx", e = c.Deferred(), q = this, g = q.length, d = 1, f = a + "defer", h = a + "queue", a = a + "mark", i; g--;)if (i = c.data(q[g], f, m, !0) || (c.data(q[g], h, m, !0) || c.data(q[g], a, m, !0)) && c.data(q[g], f, c.Callbacks("once memory"), !0))d++, i.add(b);
            b();
            return e.promise()
        }
    });
    var la = /[\n\t\r]/g, Z = /\s+/, ha = /\r/g, ia =
        /^(?:button|input)$/i, va = /^(?:button|input|object|select|textarea)$/i, ra = /^a(?:rea)?$/i, K = /^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i, N = c.support.getSetAttribute, Q, ma, Da;
    c.fn.extend({
        attr: function (a, b) {
            ...
            if (a && "string" == typeof a) {
                b = a.split(Z);
                e = 0;
                for (q = this.length; e < q; e++)if (g = this[e], 1 === g.nodeType)if (!g.className && 1 === b.length)g.className = a; else {
                    d = " " + g.className + " ";
                    f = 0;
            ...
            if (a && "string" == typeof a || a === m) {
                b = (a || "").split(Z);
                e = 0;
                for (q = this.length; e < q; e++)if (g = this[e], 1 === g.nodeType && g.className)if (a) {
            ...
            var e = typeof a, q = "boolean" == typeof b;
            return c.isFunction(a) ? this.each(function (e) {
                c(this).toggleClass(a.call(this, e, this.className, b), b)
            }) : this.each(function () {
                if ("string" ===
                    e)for (var g, d = 0, f = c(this), h = b, i = a.split(Z); g = i[d++];)h = q ? h : !f.hasClass(g), f[h ? "addClass" : "removeClass"](g); else if ("undefined" === e || "boolean" === e)this.className && c._data(this, "__className__", this.className), this.className = this.className || !1 === a ? "" : c._data(this, "__className__") || ""
            })
        }, hasClass: function (a) {
            for (var a = " " + a + " ", c = 0, b = this.length; c < b; c++)if (1 === this[c].nodeType && -1 < (" " + this[c].className + " ").replace(la, " ").indexOf(a))return !0;
            return !1
        }, val: function (a) {
            var b, e, q, g = this[0];
    ...
    c.extend({
        valHooks: {
            option: {
                ...
                get: function (a) {
                    var b, e, q = a.selectedIndex, g = [], d = a.options, f = "select-one" === a.type;
                    if (0 > q)return null;
                    a = f ? q : 0;
                    for (e = f ? q + 1 : d.length; a < e; a++)if (b = d[a], b.selected && (c.support.optDisabled ? !b.disabled : null === b.getAttribute("disabled")) && (!b.parentNode.disabled || !c.nodeName(b.parentNode, "optgroup"))) {
                        b = c(b).val();
                        if (f)return b;
                        g.push(b)
                    }
    ...
    N || (Da = {name: !0, id: !0}, Q = c.valHooks.button = {
        get: function (a, c) {
            var b;
    ...
    var La = /^(?:textarea|input|select)$/i, $a = /^([^\.]*)?(?:\.(.+))?$/, ub = /\bhover(\.\S+)?\b/, vb = /^key/, ab = /^(?:mouse|contextmenu)|click/, Ma = /^(?:focusinfocus|focusoutblur)$/, wa = /^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/, bb = function (a) {
    ...
    c.event = {
        ...
        remove: function (a, b, e, q, g) {
            var d = c.hasData(a) && c._data(a), f, h, i, k, n, l, m, j, p, r, G;
            if (d && (m = d.events)) {
                b = c.trim(xa(b || "")).split(" ");
                for (f = 0; f < b.length; f++)if (h = $a.exec(b[f]) || [], i = k = h[1], h = h[2], i) {
                    j = c.event.special[i] || {};
                ...
                } else for (i in m)c.event.remove(a, i + b[f], e, q, !0);
        ...
        trigger: function (a, b, e, q) {
            if (!e || 3 !== e.nodeType && 8 !== e.nodeType) {
                var g = a.type ||
                    a, d = [], h, i, k, n, l, j;
                if (!Ma.test(g + c.event.triggered) && (0 <= g.indexOf("!") && (g = g.slice(0, -1), h = !0), 0 <= g.indexOf(".") && (d = g.split("."), g = d.shift(), d.sort()), e && !c.event.customEvent[g] || c.event.global[g]))if (a = "object" == typeof a ? a[c.expando] ? a : new c.Event(g, a) : new c.Event(g), a.type = g, a.isTrigger = !0, a.exclusive = h, a.namespace = d.join("."), a.namespace_re = a.namespace ? RegExp("(^|\\.)" + d.join("\\.(?:.*\\.)?") + "(\\.|$)") : null, h = 0 > g.indexOf(":") ? "on" + g : "", e) {
                    if (a.result = m, a.target || (a.target = e), b = null != b ? c.makeArray(b) :
                            [], b.unshift(a), n = c.event.special[g] || {}, !(n.trigger && !1 === n.trigger.apply(e, b))) {
                        j = [[e, n.bindType || g]];
                        ...
                        for (i = 0; i < j.length && !a.isPropagationStopped(); i++)d = j[i][0], a.type = j[i][1], (l = (c._data(d, "events") || {})[a.type] && c._data(d, "handle")) && l.apply(d, b), (l = h && d[h]) && c.acceptData(d) && !1 === l.apply(d, b) &&
                        a.preventDefault();
                        a.type = g;
                ...
                } else for (i in e = c.cache, e)e[i].events && e[i].events[g] && c.event.trigger(a, b, e[i].handle.elem, !0)
            }
        },
        dispatch: function (a) {
            var a = c.event.fix(a || f.event), b = (c._data(this,
                    "events") || {})[a.type] || [], e = b.delegateCount, g = [].slice.call(arguments, 0), d = !a.exclusive && !a.namespace, h = [], i, k, n, l, j, p, r;
            g[0] = a;
                    ...
                    for (i = 0; i < e; i++) {
                        ...
                        if (j[r] === m) {
                            ...
                            if (l.quick) {
                                B = l.quick;
                                var G = k.attributes || {};
                                B = (!B[1] || k.nodeName.toLowerCase() === B[1]) && (!B[2] || (G.id || {}).value === B[2]) &&
                                    (!B[3] || B[3].test((G["class"] || {}).value))
                            } else B = n.is(r);
                            t[x] = B
                        }
                        j[r] && p.push(l)
            ...
            for (i = 0; i < h.length && !a.isPropagationStopped(); i++) {
                ...
                for (b = 0; b < e.matches.length && !a.isImmediatePropagationStopped(); b++)if (l = e.matches[b], d || !a.namespace && !l.namespace || a.namespace_re && a.namespace_re.test(l.namespace))a.data = l.data, a.handleObj = l, l = ((c.event.special[l.origType] || {}).handle || l.handler).apply(e.elem,
        ...
        mouseHooks: {
            ...
            filter: function (a, c) {
                var b, e, g, d = c.button, f = c.fromElement;
        ...
        fix: function (a) {
            ...
            var b,
                e, g = a, d = c.event.fixHooks[a.type] || {}, f = d.props ? this.props.concat(d.props) : this.props, a = c.Event(g);
    ...
    c.each({mouseenter: "mouseover", mouseleave: "mouseout"}, function (a, b) {
        c.event.special[a] = {
            delegateType: b, bindType: b, handle: function (a) {
                var e = a.relatedTarget, g = a.handleObj, d;
    ...
    c.fn.extend({
        on: function (a, b, e, g, d) {
            ...
            if (!1 === g)g = U; else if (!g)return this;
            ...
            var b = arguments, e = a.guid || c.guid++, g = 0, d = function (e) {
    ...
    (function () {
            ...
            for (var o = 0, d = e.length; o < d; o++) {
                ...
                if (f) {
                    for (var h = !1, f = f[a]; f;) {
                        ...
                        if (1 === f.nodeType)if (u || (f[g] = c, f.sizset = o), "string" != typeof b) {
                            if (f === b) {
                                h = !0;
                                break
                            }
                        } else if (0 < j.filter(b,
                                [f]).length) {
                            h = f;
                            break
                        }
        ...
        var e = /((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g, g = "sizcache" + (Math.random() + "").replace(".", ""), d = 0, f = Object.prototype.toString, h = !1, i = !0, k = /\\/g,
            n = /\r\n/g, l = /\W/;
        [0, 0].sort(function () {
            i = !1;
            return 0
        ...
        var j = function (a, b, c, o) {
            ...
            var q, d, h, I, i, k, G = !0, Va = j.isXML(b), n = [], l = a;
            do if (e.exec(""), q = e.exec(l))if (l = q[3], n.push(q[1]), q[2]) {
                I = q[3];
                break
            } while (q);
            if (1 < n.length && t.exec(a))if (2 === n.length && r.relative[n[0]])d = E(n[0] + n[1], b, o); else for (d = r.relative[n[0]] ? [b] : j(n.shift(), b); n.length;)a = n.shift(), r.relative[a] && (a += n.shift()), d = E(a, d, o); else if (!o &&
            ...
            h || (h = d);
            h || j.error(k || a);
            if ("[object Array]" === f.call(h))if (G)if (b &&
                1 === b.nodeType)for (a = 0; null != h[a]; a++)h[a] && (!0 === h[a] || 1 === h[a].nodeType && j.contains(b, h[a])) && c.push(d[a]); else for (a = 0; null != h[a]; a++)h[a] && 1 === h[a].nodeType && c.push(d[a]); else c.push.apply(c, h); else O(h, c);
        ...
        j.find = function (a,
            ...
            if (!a)return [];
            o = 0;
            for (g = r.order.length; o < g; o++)if (u = r.order[o], q = r.leftMatch[u].exec(a))if (d = q[1], q.splice(1, 1), "\\" !== d.substr(d.length - 1) && (q[1] = (q[1] || "").replace(k, ""), e = r.find[u](q, b, c), null != e)) {
        ...
        j.filter = function (a, b, c, e) {
            for (var o, g, q, u, d, f, h, I, i = a, A = [], k = b, G = b && b[0] && j.isXML(b[0]); a && b.length;) {
                for (q in r.filter)if (null != (o = r.leftMatch[q].exec(a)) &&
                    o[2])if (f = r.filter[q], d = o[1], g = !1, o.splice(1, 1), "\\" !== d.substr(d.length - 1)) {
                    k === A && (A = []);
                    if (r.preFilter[q])if (o = r.preFilter[q](o, k, c, A, e, G)) {
                        if (!0 === o)continue
                    } else g = u = !0;
                    if (o)for (h = 0; null != (d = k[h]); h++)d && (u = f(d, o, h, k), I = e ^ u, c && null != u ? I ? g = !0 : k[h] = !1 : I && (A.push(d), g = !0));
                    if (u !== m) {
                        c || (k = A);
                ...
                if (a === i)if (null == g)j.error(a); else break;
                i = a
            }
            return k
        };
        ...
        var p = j.getText = function (a) {
            ...
            } else for (b = 0; c = a[b]; b++)8 !== c.nodeType && (e += p(c));
            return e
        }, r = j.selectors = {
            order: ["ID", "NAME", "TAG"], match: {
                ...
                "+": function (a, b) {
                    var c =
                        "string" == typeof b, e = c && !l.test(b), c = c && !e;
                    e && (b = b.toLowerCase());
                    for (var e = 0, o = a.length, g; e < o; e++)if (g = a[e]) {
                        for (; (g = g.previousSibling) && 1 !== g.nodeType;);
                        a[e] = c || g && g.nodeName.toLowerCase() === b ? g || !1 : g === b
                    }
                    c && j.filter(b, a, !0)
                }, ">": function (a, b) {
                    var c, e = "string" == typeof b, o = 0, g = a.length;
                    if (e && !l.test(b))for (b = b.toLowerCase(); o < g; o++) {
                ...
                CLASS: function (a, b, c, e, o, g) {
                    ...
                    if ("not" === a[1])if (1 < (e.exec(a[3]) || "").length ||
                        /^\w/.test(a[3]))a[3] = j(a[3], null, null, b); else return a = j.filter(a[3], b, c, 1 ^ g), c || o.push.apply(o, a), !1; else if (r.match.POS.test(a[0]) || r.match.CHILD.test(a[0]))return !0;
                    return a
                }, POS: function (a) {
                    a.unshift(!0);
                    return a
                ...
                PSEUDO: function (a, b, c, e) {
                    ...
                    if ("not" === o) {
                        b = b[3];
                        c = 0;
                        for (e = b.length; c < e; c++)if (b[c] === a)return !1;
                        return !0
                    }
                    j.error(o)
                }, CHILD: function (a, b) {
                    ...
                    var c = b[1], c = j.attr ? j.attr(a, c) : r.attrHandle[c] ? r.attrHandle[c](a) : null != a[c] ? a[c] : a.getAttribute(c), e = c + "", o = b[2], g = b[4];
        ...
        try {
            ...
            O = function (a, b) {
                var c = 0, e = b || [];
                if ("[object Array]" === f.call(a))Array.prototype.push.apply(e, a); else if ("number" == typeof a.length)for (var o = a.length; c < o; c++)e.push(a[c]); else for (; a[c]; c++)e.push(a[c]);
                return e
            }
        }
        var v, H;
        s.documentElement.compareDocumentPosition ? v = function (a, b) {
            ...
            c = o.length;
            e = g.length;
            for (q = 0; q < c && q < e; q++)if (o[q] !== g[q])return H(o[q], g[q]);
        ...
        (function () {
            var a = s.createElement("div"), b = "script" + (new Date).getTime(), c = s.documentElement;
                ...
                j = function (b, c, e, o) {
                    ...
                    if (!o && !j.isXML(c)) {
                        ...
                        if (9 === c.nodeType) {
                            ...
                            var g = c, d = (q = c.getAttribute("id")) || "__sizzle__", f = c.parentNode, h = /^\s*[+~]/.test(b);
        ...
        (function () {
            ...
            if (b) {
                var c = !b.call(s.createElement("div"), "div"), e = !1;
                try {
    ...
    var Na = /Until$/, wb = /^(?:parents|prevUntil|prevAll)/, xb = /,/, rb = /^.[^:#\[\.,]*$/, yb = Array.prototype.slice, cb = c.expr.match.POS, db = {
        children: !0,
        contents: !0,
        next: !0,
        prev: !0
    ...
    c.fn.extend({
        find: function (a) {
            ...
            if ("string" != typeof a)return c(a).filter(function () {
                e =
                    0;
                for (g = b.length; e < g; e++)if (c.contains(b[e], this))return !0
            });
            var d = this.pushStack("", "find", a), f, h, i;
            e = 0;
            for (g = this.length; e < g; e++)if (f = d.length, c.find(a, this[e], d), 0 < e)for (h = f; h < d.length; h++)for (i = 0; i < f; i++)if (d[i] === d[h]) {
                d.splice(h--, 1);
                break
            }
            return d
            ...
            if (c.isArray(a)) {
                for (d = 1; f && f.ownerDocument && f !== b;) {
                    for (g = 0; g < a.length; g++)c(f).is(a[g]) && e.push({selector: a[g], elem: f, level: d});
                    f = f.parentNode;
                    d++
                }
                return e
            ...
            g = 0;
            for (d = this.length; g < d; g++)for (f = this[g]; f;) {
            ...
            var e = "string" == typeof a ? c(a, b) : c.makeArray(a && a.nodeType ? [a] : a), g = c.merge(this.get(), e);
            return this.pushStack(!e[0] || !e[0].parentNode || 11 === e[0].parentNode.nodeType || !g[0] || !g[0].parentNode || 11 === g[0].parentNode.nodeType ? g : c.unique(g))
        }, andSelf: function () {
    ...
    var Ya = "abbr|article|aside|audio|canvas|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video", zb = / jQuery\d+="(?:\d+|null)"/g, ya = /^\s+/, Oa = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig, Pa = /<([\w:]+)/, Ab = /<tbody/i, Bb = /<|&#?\w+;/, eb = /<(?:script|style)/i, fb = /<(?:script|object|embed|option|style)/i, gb = RegExp("<(?:" + Ya + ")", "i"), hb = /checked\s*(?:[^=]|=\s*.checked.)/i,
        X = /\/(java|ecma)script/i, Ja = /^\s*<!(?:\[CDATA\[|\-\-)/, Y = {
    ...
    Y.th = Y.td;
    c.support.htmlSerialize || (Y._default =
        [1, "div<div>", "</div>"]);
    c.fn.extend({
        text: function (a) {
        ...
        append: function () {
            ...
            for (var e = 0, g; null != (g = this[e]); e++)if (!a || c.filter(a, [g]).length)!b && 1 === g.nodeType && (c.cleanData(g.getElementsByTagName("*")), c.cleanData([g])), g.parentNode && g.parentNode.removeChild(g);
            return this
        }, empty: function () {
            for (var a = 0, b; null != (b = this[a]); a++)for (1 ===
            ...
            if (this[0]) {
                f =
                    i && i.parentNode;
                c.support.parentNode && f && 11 === f.nodeType && f.childNodes.length === this.length ? g = {fragment: f} : g = c.buildFragment(a, this, k);
                f = g.fragment;
    ...
    c.each({
        ...
        c.fn[a] = function (e) {
            var g = [], e = c(e), d = 1 === this.length && this[0].parentNode;
    ...
    c.extend({
        clone: function (a, b, e) {
            ...
            for (var d = [], f, h = 0, k; null != (k = a[h]); h++)if ("number" == typeof k && (k += ""), k) {
                if ("string" == typeof k)if (Bb.test(k)) {
                    k =
                        k.replace(Oa, "<$1></$2>");
                    f = (Pa.exec(k) || ["", ""])[1].toLowerCase();
                    var n = Y[f] || Y._default, j = n[0], l = b.createElement("div");
                ...
                var r;
                if (!c.support.appendChecked)if (k[0] && "number" == typeof(r = k.length))for (f = 0; f < r; f++)i(k[f]); else i(k);
            ...
            if (e) {
                ...
                for (h = 0; d[h]; h++)g && c.nodeName(d[h], "script") && (!d[h].type || "text/javascript" === d[h].type.toLowerCase()) ? g.push(d[h].parentNode ? d[h].parentNode.removeChild(d[h]) : d[h]) : (1 === d[h].nodeType && (b = c.grep(d[h].getElementsByTagName("script"), a), d.splice.apply(d,
                    [h + 1, 0].concat(b))), e.appendChild(d[h]))
            }
            return d
        }, cleanData: function (a) {
            for (var b, e, g = c.cache, d = c.event.special, f = c.support.deleteExpando, h = 0, i; null != (i = a[h]); h++)if (!i.nodeName || !c.noData[i.nodeName.toLowerCase()])if (e = i[c.expando]) {
                if ((b = g[e]) && b.events) {
    ...
    var Ea = /alpha\([^)]*\)/i, Cb = /opacity=([^)]*)/, Db = /([A-Z]|^ms)/g,
        jb = /^-?\d+(?:px)?$/i, Eb = /^-?\d/, Fb = /^([\-+])=([\-+.\de]+)/, sa = {
            position: "absolute",
            visibility: "hidden",
            display: "block"
        }, Wa = ["Left", "Right"], Xa = ["Top", "Bottom"], pa, kb, Qa;
    ...
    c.extend({
        ...
        }, cssProps: {"float": c.support.cssFloat ? "cssFloat" : "styleFloat"}, style: function (a, b, e, g) {
            if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
                var d, f = c.camelCase(b), h = a.style, i = c.cssHooks[f], b = c.cssProps[f] || f;
                if (e === m)return i && "get"in i && (d = i.get(a, !1, g)) !== m ? d : h[b];
                g = typeof e;
                "string" === g && (d = Fb.exec(e)) && (e = +(d[1] + 1) * +d[2] + parseFloat(c.css(a, b)), g = "number");
                if (!(null == e || "number" === g && isNaN(e)))if ("number" === g && !c.cssNumber[f] && (e += "px"), !i || !("set"in i) || (e = i.set(a,
                        e)) !== m)try {
                    h[b] = e
                } catch (k) {
                }
    ...
    c.support.opacity || (c.cssHooks.opacity = {
        get: function (a, b) {
            ...
            var e = a.style, g = a.currentStyle, d = c.isNumeric(b) ? "alpha(opacity=" + 100 * b + ")" : "", f = g && g.filter || e.filter || "";
            e.zoom = 1;
    ...
    s.documentElement.currentStyle && (Qa = function (a, b) {
        var c, e, g, d = a.currentStyle && a.currentStyle[b], f = a.style;
        null === d && f && (g = f[b]) && (d = g);
    ...
    var Gb = /%20/g, qb = /\[\]$/, lb = /\r?\n/g, Hb = /#.*$/, Ib = /^(.*?):[ \t]*([^\r\n]*)\r?$/mg, mb = /^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i, Jb = /^(?:GET|HEAD)$/, Kb = /^\/\//, Ra = /\?/, Lb = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, nb = /^(?:select|textarea)/i, Ia = /\s+/, Sa =
        /([?&])_=[^&]*/, Ta = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/, na = c.fn.load, ga = {}, Ua = {}, ta, oa, za = ["*/"] + ["*"];
    try {
        ta = T.href
    } catch (ob) {
    ...
    c.fn.extend({
        load: function (a, b, e) {
            ...
            var g = a.indexOf(" ");
            if (0 <= g)var d = a.slice(g, a.length), a = a.slice(0, g);
            g = "GET";
            b && (c.isFunction(b) ? (e = b, b = m) : "object" == typeof b && (b = c.param(b, c.ajaxSettings.traditional),
                g = "POST"));
            var f = this;
            c.ajax({
                url: a, type: g, dataType: "html", data: b, complete: function (a, b, g) {
                    g = a.responseText;
    ...
    c.each(["get", "post"], function (a, b) {
        c[b] = function (a, e, g, d) {
            ...
            return c.ajax({type: b, url: a, data: e, success: g, dataType: d})
        }
    });
    c.extend({
        getScript: function (a, b) {
        ...
        }, ajaxPrefilter: k(ga), ajaxTransport: k(Ua), ajax: function (a, b) {
            function e(a, b, o, u) {
                if (2 !== O) {
                    O = 2;
                    x && clearTimeout(x);
                    ...
                    var G, j, l, u = b;
                    if (o) {
                        var r = g, t = H, s = r.contents, E = r.dataTypes, Za = r.responseFields, z, P, w, C;
                        for (P in Za)P in o && (t[Za[P]] = o[P]);
                        for (; "*" === E[0];)E.shift(), z === m && (z = r.mimeType || t.getResponseHeader("content-type"));
                        if (z)for (P in s)if (s[P] && s[P].test(z)) {
                            E.unshift(P);
                            break
                        }
                        if (E[0]in o)w = E[0]; else {
                            for (P in o) {
                    ...
                    if (200 <= a && 300 > a || 304 === a) {
                        ...
                        if (304 === a)u = "notmodified", G = !0; else try {
                            z = g;
                            z.dataFilter &&
                            (o = z.dataFilter(o, z.dataType));
                            var D = z.dataTypes;
                            P = {};
                            var ka, J, y = D.length, K, W = D[0], N, Q, qa, T, L;
                            for (ka = 1; ka < y; ka++) {
                                if (1 === ka)for (J in z.converters)"string" == typeof J && (P[J.toLowerCase()] = z.converters[J]);
                                N = W;
                                W = D[ka];
                                if ("*" === W)W = N; else if ("*" !== N && N !== W) {
                                    Q = N + " " + W;
                                    qa = P[Q] || P["* " + W];
                                    if (!qa)for (T in L = m, P)if (K = T.split(" "), K[0] === N || "*" === K[0])if (L = P[K[1] + " " + W]) {
                                        T = P[T];
                                        !0 === T ? qa = L : !0 === L && (qa = T);
                                        break
                                    }
            ...
            var b = b || {}, g = c.ajaxSetup({}, b), d = g.context || g, f = d !== g && (d.nodeType || d instanceof c) ? c(d) : c.event, h = c.Deferred(), i = c.Callbacks("once memory"),
                k = g.statusCode || {}, n, j = {}, l = {}, p, t, B, x, G, O = 0, v, s, H = {
                    readyState: 0,
                    ...
                    getResponseHeader: function (a) {
                        var b;
                        if (2 === O) {
                            if (!t)for (t = {}; b = Ib.exec(p);)t[b[1].toLowerCase()] = b[2];
                            b = t[a.toLowerCase()]
                        }
                        return b === m ? null : b
                    },
            ...
            H.statusCode = function (a) {
                if (a) {
                    var b;
                    if (2 > O)for (b in a)k[b] = [k[b], a[b]]; else b = a[H.status], H.then(b, b)
                }
                return this
            };
            ...
            for (s in{success: 1, error: 1, complete: 1})H[s](g[s]);
            if (B = r(Ua, g, b, H)) {
                H.readyState = 1;
                v && f.trigger("ajaxSend",
                    [H, g]);
            ...
            }); else for (var d in a)x(d, a[d], b, g);
    ...
    c.ajaxPrefilter("json jsonp", function (a, b, e) {
        ...
        if ("jsonp" === a.dataTypes[0] || !1 !== a.jsonp && (ja.test(a.url) || b && ja.test(a.data))) {
            var g, d = a.jsonpCallback = c.isFunction(a.jsonpCallback) ? a.jsonpCallback() : a.jsonpCallback, h = f[d], i = a.url, k = a.data, n = "$1" + d +
                "$2";
        ...
        if (!a.crossDomain || c.support.cors) {
            ...
            return {
                send: function (e, g) {
                    ...
                    if (a.xhrFields)for (i in a.xhrFields)d[i] = a.xhrFields[i];
                    ...
                    b = function (e,
                        ...
                        var u, i, k, n, j;
                        try {
                            if (b && (f || 4 === d.readyState))if (b = m, h && (d.onreadystatechange = c.noop, Aa && delete aa[h]), f)4 !== d.readyState && d.abort(); else {
                                u = d.status;
    ...
    var Ga = {}, ba, fa, pb = /^(?:toggle|show|hide)$/, Ba = /^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i, Fa, Ha = [["height", "marginTop", "marginBottom", "paddingTop", "paddingBottom"], ["width", "marginLeft", "marginRight", "paddingLeft", "paddingRight"], ["opacity"]], b;
    c.fn.extend({
        show: function (a, b, e) {
            var g;
            ...
            for (b = 0; b < e; b++)if (a = this[b], a.style && (g = a.style.display, "" === g || "none" === g))a.style.display = c._data(a, "olddisplay") || "";
            return this
        }, hide: function (a, b, e) {
            ...
            function d() {
                ...
                var b = c.extend({}, f), e = 1 === this.nodeType, g = e && c(this).is(":hidden"), o, q, u, h, i, k, n, G;
            ...
            return this.each(function () {
                var b, g = !1, o = c.timers, d = c._data(this);
                e || c._unmark(!0, this);
                if (null == a)for (b in d) {
    ...
    c.extend({
        speed: function (a, b, e) {
            var g = a && "object" == typeof a ? c.extend({}, a) : {
                complete: e ||
                !e && b || c.isFunction(a) && a, duration: a, easing: e && b || b && !c.isFunction(b) && b
            };
    ...
    c.fx.prototype = {
        update: function () {
            ...
            var e, g, d = b || l(), f = !0, h = this.elem, i = this.options;
            if (a || d >= i.duration + this.startTime) {
                ...
                if (f) {
                    ...
                    i.hide && c(h).hide();
                    if (i.hide || i.show)for (e in i.animatedProperties)c.style(h, e, i.orig[e]), c.removeData(h, "fxshow" + e, !0), c.removeData(h, "toggle" + e, !0);
    ...
    var e = /^t(?:able|d|h)$/i, g = /^(?:body|html)$/i;
    "getBoundingClientRect"in s.documentElement ? c.fn.offset = function (a) {
        ...
        var d = b.ownerDocument, f = d.documentElement;
        ...
        if (!b || !b.ownerDocument)return null;
        if (b === b.ownerDocument.body)return c.offset.bodyOffset(b);
        var g, d = b.offsetParent, f = b.ownerDocument, h = f.documentElement, i = f.body;
        g = (f = f.defaultView) ? f.getComputedStyle(b, null) : b.currentStyle;
        for (var k = b.offsetTop, n = b.offsetLeft; (b = b.parentNode) && b !== i && b !== h && !(c.support.fixedPosition && "fixed" === g.position);)g = f ? f.getComputedStyle(b, null) : b.currentStyle, k -= b.scrollTop, n -= b.scrollLeft, b === d && (k += b.offsetTop, n += b.offsetLeft, c.support.doesNotAddBorder && (!c.support.doesAddBorderForTableAndCells || !e.test(b.nodeName)) && (k += parseFloat(g.borderTopWidth) || 0, n += parseFloat(g.borderLeftWidth) || 0), d = b.offsetParent), c.support.subtractsBorderForOverflowNotVisible && "visible" !== g.overflow && (k += parseFloat(g.borderTopWidth) || 0, n += parseFloat(g.borderLeftWidth) || 0);
    ...
    c.offset = {
        bodyOffset: function (a) {
            ...
            var d = c(a), f = d.offset(), h = c.css(a, "top"), i = c.css(a, "left"), k = {}, n = {}, j, l;
    ...
    c.fn.extend({
        position: function () {
            ...
            var a = this[0], b = this.offsetParent(), e = this.offset(), d = g.test(b[0].nodeName) ? {
                top: 0,
                left: 0
            } : b.offset();
    ...
    c.each(["Height", "Width"], function (a, b) {
        ...
        c.fn[e] = function (a) {
            ...
            if (c.isWindow(g)) {
                var d =
                    g.document.documentElement["client" + b], f = g.document.body;
...
(function (f, m) {
    ...
    function w(b) {
        if (!Aa[b]) {
            var e = s.body, g = c("<" + b + ">").appendTo(e), a = g.css("display");
            g.remove();
            if ("none" === a || "" === a) {
    ...
    function v(b, e, g, a) {
        ...
        }); else if (!g && null != e && "object" == typeof e)for (var d in e)v(b + "[" + d + "]", e[d], g, a); else a(b, e)
    }
    ...
    function r(b) {
        return function (e, g) {
            ...
            if (c.isFunction(g))for (var a = e.toLowerCase().split(Ra), d = 0, f = a.length, h, i; d < f; d++)h = a[d], (i = /^\+/.test(h)) &&
            (h = h.substr(1) || "*"), h = b[h] = b[h] || [], h[i ? "unshift" : "push"](g)
        }
    }

    function k(b, e, g) {
        var a = "width" === e ? b.offsetWidth : b.offsetHeight, d = "width" === e ? Eb : Fb;
    ...
    function B(b, e) {
        ...
        if (1 === e.nodeType) {
            ...
            if ("object" === g)e.outerHTML = b.outerHTML; else if ("input" !== g || "checkbox" !== b.type && "radio" !== b.type)if ("option" === g)e.selected = b.defaultSelected; else {
    ...
    function J(b, e) {
        if (1 === e.nodeType && c.hasData(b)) {
            var g = c.expando, a = c.data(b), d = c.data(e, a);
            if (a = a[g]) {
                var f = a.events, d = d[g] = c.extend({}, a);
                if (f) {
                    delete d.handle;
                    d.events = {};
                    for (var h in f) {
    ...
    function D(b) {
        ...
        if (!(b.liveFired === this || !f || !f.live || b.target.disabled || b.button && "click" === b.type)) {
            ...
            for (n = d.length; k < n; k++) {
                j = d[k];
                for (i = 0; i < m.length; i++)if (f = m[i], j.selector === f.selector && (!l || l.test(f.namespace)) && !j.elem.disabled) {
                    h = j.elem;
                    a = null;
            ...
            for (n = r.length; k < n; k++) {
                ...
                if (!1 === l || b.isPropagationStopped())if (g = d.level, !1 === l && (e = !1), b.isImmediatePropagationStopped())break
            }
            return e
        }
    }
    ...
    function R(b, e, g) {
        var a = e + "defer", d = e + "queue", f = e + "mark", h = c.data(b, a, m, !0);
    ...
    function ca(b) {
        for (var c in b)if ("toJSON" !== c)return !1;
        return !0
    }

    function V(b, e, g) {
        if (g === m && 1 === b.nodeType)if (g = "data-" + e.replace(da, "-$1").toLowerCase(), g = b.getAttribute(g), "string" == typeof g) {
            try {
    ...
    var s = f.document, $ = f.navigator, T = f.location, c = function () {
        ...
        var c = function (a, b) {
            ...
            }, g = f.jQuery, a = f.$, d, h = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, i = /\S/, k = /^\s+/, n = /\s+$/, j = /\d/, l = /^<(\w+)\s*\/?>(?:<\/\1>)?$/, r = /^[\],:{}\s]*$/, p = /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, t = /"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
            B = /(?:^|:|,)(?:\s*\[)+/g, x = /(webkit)[ \/]([\w.]+)/, v = /(opera)(?:.*version)?[ \/]([\w.]+)/, E = /(msie) ([\w.]+)/, z = /(mozilla)(?:.*? rv:([\w.]+))?/, G = /-([a-z]|[0-9])/ig, O = /^-ms-/, Pb = function (a, b) {
                return (b + "").toUpperCase()
            }, Za = $.userAgent, H, P, w, C = Object.prototype.toString, D = Object.prototype.hasOwnProperty, J = Array.prototype.push, K = Array.prototype.slice, y = String.prototype.trim, N = Array.prototype.indexOf, Q = {};
        return c.fn = c.prototype = {
            constructor: c, init: function (a, b, g) {
                var d, f, o;
                if (!a)return this;
            ...
            var a, b, g, d, f, o, h = arguments[0] || {}, i = 1, q = arguments.length, k = !1;
            "boolean" == typeof h && (k = h, h = arguments[1] || {}, i = 2);
            "object" != typeof h && !c.isFunction(h) && (h =
            {});
            for (q === i && (h = this, --i); i < q; i++)if (null != (a = arguments[i]))for (b in a)g = h[b], d = a[b], h !== d && (k && d && (c.isPlainObject(d) || (f = c.isArray(d))) ? (f ? (f = !1, o = g && c.isArray(g) ? g : []) : o = g && c.isPlainObject(g) ? g : {}, h[b] = c.extend(k, o, d)) : d !== m && (h[b] = d));
            return h
        }, c.extend({
            noConflict: function (b) {
                ...
                if (!P) {
                    P = c._Deferred();
                    if ("complete" === s.readyState)return setTimeout(c.ready, 1);
                    if (s.addEventListener)s.addEventListener("DOMContentLoaded", w, !1), f.addEventListener("load", c.ready, !1); else if (s.attachEvent) {
            ...
            isFunction: function (a) {
                ...
                var d, f = 0, o = a.length, h = o === m || c.isFunction(a);
                if (g)if (h)for (d in a) {
                    if (!1 === b.apply(a[d],
                            g))break
                } else for (; f < o && !1 !== b.apply(a[f++], g);); else if (h)for (d in a) {
                    if (!1 === b.call(a[d], d, a[d]))break
                } else for (; f < o && !1 !== b.call(a[f], f, a[f++]););
                return a
            }, trim: y ? function (a) {
                ...
                if (N)return N.call(b,
                    a);
                for (var c = 0, e = b.length; c < e; c++)if (b[c] === a)return c;
                return -1
            }, merge: function (a, b) {
                var c = a.length, e = 0;
                if ("number" == typeof b.length)for (var g = b.length; e < g; e++)a[c++] = b[e]; else for (; b[e] !== m;)a[c++] = b[e++];
                return a.length = c, a
            }, grep: function (a, b, c) {
                for (var e = [], g, c = !!c, d = 0, f = a.length; d < f; d++)g = !!b(a[d], d), c !== g && e.push(a[d]);
                return e
            }, map: function (a, b, g) {
                var d, f, o = [], h = 0, i = a.length;
                if (a instanceof c || i !== m && "number" == typeof i && (0 < i && a[0] && a[i - 1] || 0 === i || c.isArray(a)))for (; h < i; h++)d = b(a[h], h, g), null !=
                d && (o[o.length] = d); else for (f in a)d = b(a[f], f, g), null != d && (o[o.length] = d);
                return o.concat.apply([], o)
            }, guid: 1, proxy: function (a, b) {
                if ("string" == typeof b)var g = a[b], b = a, a = g;
                if (!c.isFunction(a))return m;
                var d = K.call(arguments, 2), g = function () {
    ...
    c.extend({
        _Deferred: function () {
            ...
            var e = c._Deferred(), g = c._Deferred(), a;
            return c.extend(e, {
                then: function (a, b) {
            ...
            var g = arguments, a = 0, d = g.length, f = d, h = 1 >= d && b && c.isFunction(b.promise) ? b : c.Deferred();
            if (1 < d) {
    ...
    c.support = function () {
        var b = s.createElement("div"), e = s.documentElement, g, a, d, f, h, i, k;
        ...
        b.innerHTML = "";
        s.defaultView && s.defaultView.getComputedStyle && (h = s.createElement("div"), h.style.width = "0", h.style.marginRight = "0", b.appendChild(h), i.reliableMarginRight = 0 === (parseInt((s.defaultView.getComputedStyle(h, null) || {marginRight: 0}).marginRight, 10) || 0));
        a.innerHTML = "";
        e.removeChild(a);
        if (b.attachEvent)for (k in{submit: 1, change: 1, focusin: 1})h = "on" + k, (g = h in b) || (b.setAttribute(h,
    ...
    c.extend({
        ...
        data: function (b, e, g, a) {
            if (c.acceptData(b)) {
                var d, f, h = c.expando, i = "string" == typeof e,
                    k = b.nodeType, n = k ? c.cache : b, j = k ? b[c.expando] : b[c.expando] && c.expando;
        ...
        removeData: function (b, e, g) {
            if (c.acceptData(b)) {
                var a,
                    d = c.expando, f = b.nodeType, h = f ? c.cache : b, i = f ? b[c.expando] : c.expando;
                if (h[i]) {
                    if (e && (a = g ? h[i][d] : h[i]))if (a[e] || (e = c.camelCase(e)), delete a[e], !ca(a))return;
    ...
    c.fn.extend({
        data: function (b, e) {
            ...
            if ("undefined" == typeof b) {
                if (this.length && (g = c.data(this[0]), 1 === this[0].nodeType))for (var a = this[0].attributes, d, f = 0, h = a.length; f < h; f++)d = a[f].name, 0 === d.indexOf("data-") && (d = c.camelCase(d.substring(5)), V(this[0], d, g[d]));
                return g
            }
    ...
    c.fn.extend({
        queue: function (b, e) {
            return "string" != typeof b && (e = b, b = "fx"), e === m ? c.queue(this[0], b) : this.each(function () {
            ...
            "string" != typeof b && (b = m);
            for (var b =
                b || "fx", g = c.Deferred(), a = this, d = a.length, f = 1, h = b + "defer", i = b + "queue", b = b + "mark", k; d--;)if (k = c.data(a[d], h, m, !0) || (c.data(a[d], i, m, !0) || c.data(a[d], b, m, !0)) && c.data(a[d], h, c._Deferred(), !0))f++, k.done(e);
            return e(), g.promise()
        }
    });
    var la = /[\n\t\r]/g, Z = /\s+/, ha = /\r/g, ia = /^(?:button|input)$/i, va = /^(?:button|input|object|select|textarea)$/i, ra = /^a(?:rea)?$/i, K = /^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i, N, Q;
    c.fn.extend({
        attr: function (b,
                        e) {
            ...
            if (b && "string" == typeof b) {
                e = b.split(Z);
                g = 0;
                for (a = this.length; g < a; g++)if (d = this[g],
                    1 === d.nodeType)if (!d.className && 1 === e.length)d.className = b; else {
                    f = " " + d.className + " ";
                    h = 0;
            ...
            if (b && "string" == typeof b || b === m) {
                e = (b || "").split(Z);
                g = 0;
                for (a = this.length; g < a; g++)if (d = this[g], 1 === d.nodeType && d.className)if (b) {
            ...
            var g = typeof b, a = "boolean" == typeof e;
            return c.isFunction(b) ? this.each(function (a) {
                c(this).toggleClass(b.call(this, a, this.className, e), e)
            }) : this.each(function () {
                if ("string" === g)for (var d, f = 0, h = c(this), i = e, k = b.split(Z); d = k[f++];)i = a ? i : !h.hasClass(d), h[i ? "addClass" : "removeClass"](d); else if ("undefined" === g || "boolean" === g)this.className && c._data(this, "__className__",
                    this.className), this.className = this.className || !1 === b ? "" : c._data(this, "__className__") || ""
            })
        }, hasClass: function (b) {
            for (var b = " " + b + " ", c = 0, g = this.length; c < g; c++)if (1 === this[c].nodeType && -1 < (" " + this[c].className + " ").replace(la, " ").indexOf(b))return !0;
            return !1
        }, val: function (b) {
            var e, g, a = this[0];
    ...
    c.extend({
        valHooks: {
            option: {
                ...
                get: function (b) {
                    var e, g = b.selectedIndex, a = [], d = b.options,
                        b = "select-one" === b.type;
                    if (0 > g)return null;
                    for (var f = b ? g : 0, h = b ? g + 1 : d.length; f < h; f++)if (e = d[f], e.selected && (c.support.optDisabled ? !e.disabled : null === e.getAttribute("disabled")) && (!e.parentNode.disabled || !c.nodeName(e.parentNode, "optgroup"))) {
                        e = c(e).val();
                        if (b)return e;
                        a.push(e)
                    }
        ...
        attrHooks: {
            type: {
                set: function (b, e) {
                    if (ia.test(b.nodeName) && b.parentNode)c.error("type property can't be changed"); else if (!c.support.radioValue && "radio" === e && c.nodeName(b, "input")) {
                        var g = b.value;
    ...
    var ma = /\.(.*)$/, Da = /^(?:textarea|input|select)$/i, La = /\./g, $a = / /g, ub = /[^\w\s.|`]/g, vb = function (b) {
        return b.replace(ub, "\\$&")
    };
    c.event = {
        ...
        remove: function (b, e, g, a) {
            if (3 !== b.nodeType && 8 !== b.nodeType) {
                !1 === g && (g = F);
                var d, f, h = 0, i, k, n, j, l, r, p = c.hasData(b) && c._data(b), t = p && p.events;
                if (p && t)if (e && e.type && (g = e.handler, e = e.type), !e || "string" == typeof e &&
                    "." === e.charAt(0))for (d in e = e || "", t)c.event.remove(b, d + e); else {
                    for (e = e.split(" "); d = e[h++];)if (j = d, i = 0 > d.indexOf("."), k = [], i || (k = d.split("."), d = k.shift(), n = RegExp("(^|\\.)" + c.map(k.slice(0).sort(), vb).join("\\.(?:.*\\.)?") + "(\\.|$)")), l = t[d])if (g) {
                        j = c.event.special[d] || {};
                        for (f = a || 0; f < l.length; f++)if (r = l[f], g.guid === r.guid) {
                    ...
                    } else for (f = 0; f < l.length; f++)if (r = l[f], i || n.test(r.namespace))c.event.remove(b, j, r.handler, f), l.splice(f--, 1);
        ...
        handle: function (b) {
            var b = c.event.fix(b || f.event), e = ((c._data(this, "events") || {})[b.type] || []).slice(0), g = !b.exclusive && !b.namespace, a = Array.prototype.slice.call(arguments, 0);
            a[0] = b;
            b.currentTarget = this;
            for (var d = 0, h = e.length; d < h; d++) {
                var i = e[d];
                if (g || b.namespace_re.test(i.namespace))if (b.handler = i.handler, b.data = i.data, b.handleObj = i, i = i.handler.apply(this, a), i !== m && (b.result = i, !1 === i && (b.preventDefault(), b.stopPropagation())), b.isImmediatePropagationStopped())break
            }
            return b.result
        },
        ...
        special: {
            ready: {setup: c.bindReady, teardown: c.noop}, live: {
                add: function (b) {
                    c.event.add(this, E(b.origType, b.selector), c.extend({}, b, {handler: D, guid: b.handler.guid}))
                }, remove: function (b) {
    ...
    c.each({mouseenter: "mouseover", mouseleave: "mouseout"}, function (b, e) {
        c.event.special[b] = {
            setup: function (g) {
    ...
    c.support.submitBubbles || (c.event.special.submit = {
        setup: function () {
            ...
            c.event.add(this, "click.specialSubmit", function (b) {
                var e = b.target, g = c.nodeName(e, "input") || c.nodeName(e, "button") ? e.type : "";
    ...
    if (!c.support.changeBubbles) {
        var wa, bb = function (b) {
            var e = c.nodeName(b, "input") ? b.type : "", g = b.value;
            ...
            var g = b.target, a, d;
            if (Da.test(g.nodeName) && !g.readOnly && (a = c._data(g, "_change_data"), d = bb(g), ("focusout" !== b.type || "radio" !== g.type) && c._data(g, "_change_data", d), !(a === m || d === a)))if (null !=
                a || d)b.type = "change", b.liveFired = m, c.event.trigger(b, e, g)
        };
        c.event.special.change = {
            filters: {
                focusout: xa, beforedeactivate: xa, click: function (b) {
                    var e = b.target, g = c.nodeName(e, "input") ? e.type : "";
    ...
    c.support.focusinBubbles || c.each({focus: "focusin", blur: "focusout"}, function (b, e) {
        function g(a) {
            var b = c.event.fix(a);
            b.type = e;
            b.originalEvent = {};
    ...
    c.each(["bind", "one"], function (b, e) {
        c.fn[e] = function (b, a, d) {
            ...
            if ("unload" === b && "one" !== e)this.one(b, a, d); else {
                h = 0;
                for (var i =
    ...
    c.fn.extend({
        unbind: function (b, e) {
            if ("object" == typeof b && !b.preventDefault)for (var g in b)this.unbind(g, b[g]); else {
                g = 0;
            ...
            var e = arguments, g = b.guid || c.guid++, a = 0, d = function (g) {
    ...
    c.each(["live", "die"],
        function (b, e) {
            c.fn[e] = function (b, a, d, f) {
                var h = 0, i, k, n = f || this.selector, j = f ? this : c(this.context);
                ...
                for (b = (b || "").split(" "); null != (f = b[h++]);)if (i = ma.exec(f), k = "", i && (k = i[0], f = f.replace(ma, "")), "hover" === f)b.push("mouseenter" + k, "mouseleave" + k); else if (i = f, Na[f] ? (b.push(Na[f] + k), f += k) : f = (Na[f] || f) + k, "live" === e) {
                    k = 0;
                    for (var l =
    ...
    (function () {
            ...
            for (var g = 0, f = e.length; g < f; g++) {
                ...
                if (h) {
                    for (var i = !1, h = h[a]; h;) {
                        ...
                        if (1 === h.nodeType)if (d || (h.sizcache = c, h.sizset = g), "string" != typeof b) {
                            if (h === b) {
                                i = !0;
                                break
                            }
        ...
        var g = /((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g, a = 0, d = Object.prototype.toString, f = !1, h = !0, i = /\\/g, k = /\W/;
        [0, 0].sort(function () {
            return h = !1, 0
        });
        var n = function (a, b, c, e) {
            ...
            if (1 !== b.nodeType && 9 !== b.nodeType)return [];
            if (!a || "string" != typeof a)return c;
            var h, i, k, q, u, r, p = !0, m = n.isXML(b), B = [], x = a;
            do if (g.exec(""), h = g.exec(x))if (x = h[3], B.push(h[1]), h[2]) {
                q = h[3];
                break
            } while (h);
            if (1 < B.length && l.exec(a))if (2 === B.length && j.relative[B[0]])i = E(B[0] + B[1], b); else for (i = j.relative[B[0]] ? [b] : n(B.shift(), b); B.length;)a = B.shift(), j.relative[a] && (a += B.shift()), i = E(a, i); else if (!e && 1 < B.length && 9 === b.nodeType && !m && j.match.ID.test(B[0]) && !j.match.ID.test(B[B.length - 1]) && (u = n.find(B.shift(), b, m), b = u.expr ? n.filter(u.expr, u.set)[0] : u.set[0]), b) {
                u = e ? {
                    expr: B.pop(),
                    set: t(e)
            ...
            k || (k = i);
            k || n.error(r || a);
            if ("[object Array]" === d.call(k))if (p)if (b && 1 === b.nodeType)for (a = 0; null != k[a]; a++)k[a] && (!0 === k[a] || 1 === k[a].nodeType && n.contains(b, k[a])) && c.push(i[a]); else for (a = 0; null != k[a]; a++)k[a] && 1 === k[a].nodeType && c.push(i[a]); else c.push.apply(c, k); else t(k, c);
            return q && (n(q, f, c, e), n.uniqueSort(c)), c
        };
        n.uniqueSort = function (a) {
            if (x && (f = h, a.sort(x), f))for (var b =
        ...
        n.find = function (a, b, c) {
            ...
            return e || (e = "undefined" != typeof b.getElementsByTagName ?
                b.getElementsByTagName("*") : []), {set: e, expr: a}
        };
        n.filter = function (a, b, c, e) {
            for (var g, d, f = a, h = [], i = b, k = b && b[0] && n.isXML(b[0]); a && b.length;) {
                for (var o in j.filter)if (null != (g = j.leftMatch[o].exec(a)) && g[2]) {
                    ...
                    if ("\\" !== l.substr(l.length - 1)) {
                        i === h && (h = []);
                        if (j.preFilter[o])if (g = j.preFilter[o](g, i, c, h, e, k)) {
                            if (!0 === g)continue
                        } else d = q = !0;
                        if (g)for (var r = 0; null != (l = i[r]); r++)if (l) {
                            q = u(l, g, r, i);
                            var p = e ^ !!q;
                ...
                if (a === f)if (null == d)n.error(a); else break;
                f = a
            }
            return i
        };
        ...
        var j = n.selectors = {
            order: ["ID", "NAME", "TAG"], match: {
                ...
                "+": function (a, b) {
                    var c = "string" == typeof b, e = c && !k.test(b),
                        c = c && !e;
                    e && (b = b.toLowerCase());
                    for (var e = 0, g = a.length, d; e < g; e++)if (d = a[e]) {
                        for (; (d = d.previousSibling) && 1 !== d.nodeType;);
                        a[e] = c || d && d.nodeName.toLowerCase() === b ? d || !1 : d === b
                    }
                    c && n.filter(b, a, !0)
                }, ">": function (a, b) {
                    var c, e = "string" == typeof b, g = 0, d = a.length;
                    if (e && !k.test(b))for (b = b.toLowerCase(); g < d; g++) {
                ...
                CLASS: function (a, b, c, e, g, d) {
                    ...
                    if ("not" === a[1])if (1 < (g.exec(a[3]) || "").length || /^\w/.test(a[3]))a[3] = n(a[3],
                        null, null, b); else return a = n.filter(a[3], b, c, 1 ^ d), c || e.push.apply(e, a), !1; else if (j.match.POS.test(a[0]) || j.match.CHILD.test(a[0]))return !0;
                    return a
                }, POS: function (a) {
                ...
                PSEUDO: function (a, b, c, e) {
                    ...
                    switch (c) {
                        ...
                        case "nth":
                            ...
                            if (f && (f.sizcache !== d || !a.nodeIndex)) {
                                for (var h = 0, e = f.firstChild; e; e = e.nextSibling)1 === e.nodeType && (e.nodeIndex = ++h);
                                f.sizcache = d
                            }
                            e = a.nodeIndex - g;
                    ...
                    var c = b[1], c = j.attrHandle[c] ? j.attrHandle[c](a) : null != a[c] ? a[c] : a.getAttribute(c), e = c + "", g = b[2], d = b[4];
        ...
        try {
            ...
            t = function (a, b) {
                var c = 0, e = b || [];
                if ("[object Array]" === d.call(a))Array.prototype.push.apply(e, a); else if ("number" == typeof a.length)for (var g = a.length; c < g; c++)e.push(a[c]); else for (; a[c]; c++)e.push(a[c]);
                return e
            }
        }
        var x, v;
        s.documentElement.compareDocumentPosition ? x = function (a, b) {
            ...
            c = g.length;
            e = d.length;
            for (h = 0; h < c && h < e; h++)if (g[h] !== d[h])return v(g[h], d[h]);
        ...
        (function () {
            ...
            a.innerHTML = "<a href='#'></a>";
            a.firstChild && "undefined" != typeof a.firstChild.getAttribute && "#" !== a.firstChild.getAttribute("href") && (j.attrHandle.href = function (a) {
                return a.getAttribute("href", 2)
            });
            a = null
        })();
        s.querySelectorAll && function () {
            var a = n, b = s.createElement("div");
            b.innerHTML = "<p class='TEST'></p>";
            if (!b.querySelectorAll || 0 !== b.querySelectorAll(".TEST").length) {
                n = function (b, c, e, g) {
                    c = c || s;
                    if (!g && !n.isXML(c)) {
                        ...
                        if (9 === c.nodeType) {
                            ...
                            var d = c, i = (f = c.getAttribute("id")) || "__sizzle__", k = c.parentNode, o = /^\s*[+~]/.test(b);
    ...
    var wb = /Until$/, xb = /^(?:parents|prevUntil|prevAll)/, rb = /,/, yb = /^.[^:#\[\.,]*$/, cb = Array.prototype.slice, db = c.expr.match.POS, Ya = {
        children: !0,
        contents: !0,
        next: !0,
        prev: !0
    ...
    c.fn.extend({
        find: function (b) {
            ...
            if ("string" != typeof b)return c(b).filter(function () {
                g =
                    0;
                for (a = e.length; g < a; g++)if (c.contains(e[g], this))return !0
            });
            var d = this.pushStack("", "find", b), f, h, i;
            g = 0;
            for (a = this.length; g < a; g++)if (f = d.length, c.find(b, this[g], d), 0 < g)for (h = f; h < d.length; h++)for (i = 0; i < f; i++)if (d[i] === d[h]) {
                d.splice(h--, 1);
                break
            }
            return d
            ...
            var e = c(b);
            return this.filter(function () {
                for (var b = 0, a = e.length; b < a; b++)if (c.contains(this, e[b]))return !0
            })
        }, not: function (b) {
            ...
            var g = "string" == typeof b ? c(b, e) : c.makeArray(b && b.nodeType ? [b] : b), a = c.merge(this.get(), g);
            return this.pushStack(!g[0] || !g[0].parentNode || 11 === g[0].parentNode.nodeType || !a[0] || !a[0].parentNode || 11 === a[0].parentNode.nodeType ? a : c.unique(a))
        }, andSelf: function () {
            return this.add(this.prevObject)
        }
    });
    c.each({
        ...
        c.fn[b] = function (g, a) {
            var d = c.map(this, e, g), f = cb.call(arguments);
            return wb.test(b) ||
    ...
    var zb = / jQuery\d+="(?:\d+|null)"/g, ya = /^\s+/, Oa = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig, Pa = /<([\w:]+)/, Ab = /<tbody/i, Bb = /<|&#?\w+;/, eb = /<(?:script|object|embed|option|style)/i, fb = /checked\s*(?:[^=]|=\s*.checked.)/i, gb = /\/(java|ecma)script/i, hb = /^\s*<!(?:\[CDATA\[|\-\-)/, X = {
        option: [1, "<select multiple='multiple'>", "</select>"],
        legend: [1,
            "<fieldset>", "</fieldset>"],
        thead: [1, "<table>", "</table>"],
    ...
    c.fn.extend({
        text: function (b) {
            ...
            for (var g = 0, a; null != (a = this[g]); g++)if (!b || c.filter(b, [a]).length)!e && 1 === a.nodeType && (c.cleanData(a.getElementsByTagName("*")), c.cleanData([a])), a.parentNode && a.parentNode.removeChild(a);
            return this
        }, empty: function () {
            for (var b = 0, e; null != (e = this[b]); b++)for (1 === e.nodeType && c.cleanData(e.getElementsByTagName("*")); e.firstChild;)e.removeChild(e.firstChild);
            return this
        }, clone: function (b, e) {
            ...
            if (this[0]) {
                h = i && i.parentNode;
                c.support.parentNode && h && 11 === h.nodeType && h.childNodes.length === this.length ? a = {fragment: h} : a = c.buildFragment(b, this, k);
                h = a.fragment;
    ...
    c.each({
        ...
        c.fn[b] = function (g) {
            var a = [], g = c(g), d = 1 === this.length && this[0].parentNode;
    ...
    c.extend({
        clone: function (b, e, g) {
            ...
            for (var d = [], f, i = 0, k; null != (k = b[i]); i++)if ("number" == typeof k && (k += ""), k) {
                if ("string" == typeof k)if (Bb.test(k)) {
                    k = k.replace(Oa, "<$1></$2>");
                    f = (Pa.exec(k) || ["", ""])[1].toLowerCase();
                    var n = X[f] || X._default, j = n[0], l = e.createElement("div");
                    for (l.innerHTML = n[1] + k + n[2]; j--;)l = l.lastChild;
                    if (!c.support.tbody) {
                        j = Ab.test(k);
                        n = "table" === f && !j ? l.firstChild && l.firstChild.childNodes : "<table>" === n[1] && !j ? l.childNodes : [];
                ...
                var r;
                if (!c.support.appendChecked)if (k[0] && "number" == typeof(r = k.length))for (f = 0; f < r; f++)h(k[f]); else h(k);
                k.nodeType ? d.push(k) : d = c.merge(d, k)
            }
            if (g) {
                b = function (a) {
            ...
            for (var e, g, a = c.cache, d = c.expando, f = c.event.special, h = c.support.deleteExpando, i = 0, k; null != (k = b[i]); i++)if (!k.nodeName || !c.noData[k.nodeName.toLowerCase()])if (g = k[c.expando]) {
    ...
    var Ja = /alpha\([^)]*\)/i, Y = /opacity=([^)]*)/, ib = /([A-Z]|^ms)/g, Ea = /^-?\d+(?:px)?$/i, Cb = /^-?\d/, Db = /^([\-+])=([\-+.\de]+)/, jb = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    }, Eb = ["Left", "Right"], Fb = ["Top", "Bottom"], sa, Wa, Xa;
    ...
    c.extend({
        ...
        style: function (b, e, g, a) {
            if (b && 3 !== b.nodeType && 8 !== b.nodeType && b.style) {
                var d, f = c.camelCase(e), h = b.style, i = c.cssHooks[f], e = c.cssProps[f] || f;
                if (g === m)return i && "get"in i && (d = i.get(b, !1, a)) !== m ? d : h[e];
                a = typeof g;
                "string" === a && (d = Db.exec(g)) && (g = +(d[1] +
                    1) * +d[2] + parseFloat(c.css(b, e)), a = "number");
                if (!(null == g || "number" === a && isNaN(g)))if ("number" === a && !c.cssNumber[f] && (g += "px"), !i || !("set"in i) || (g = i.set(b, g)) !== m)try {
                    h[e] = g
                } catch (k) {
                }
            }
    ...
    c.support.opacity || (c.cssHooks.opacity = {
        get: function (b, c) {
            ...
            var g = b.style, a = b.currentStyle, d = c.isNaN(e) ? "" : "alpha(opacity=" + 100 * e + ")", f = a && a.filter ||
                g.filter || "";
            g.zoom = 1;
    ...
    c(function () {
        c.support.reliableMarginRight || (c.cssHooks.marginRight = {
            get: function (b, e) {
                var g;
                return c.swap(b, {display: "inline-block"}, function () {
    ...
    s.documentElement.currentStyle && (Xa = function (b, c) {
        var g, a = b.currentStyle && b.currentStyle[c], d = b.runtimeStyle && b.runtimeStyle[c], f = b.style;
    ...
    var pa = /%20/g, kb = /\[\]$/, Qa = /\r?\n/g, Gb = /#.*$/, qb = /^(.*?):[ \t]*([^\r\n]*)\r?$/mg, lb = /^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i, Hb = /^(?:GET|HEAD)$/, Ib = /^\/\//, mb = /\?/, Jb = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,
        Kb = /^(?:select|textarea)/i, Ra = /\s+/, Lb = /([?&])_=[^&]*/, nb = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/, Ia = c.fn.load, Sa = {}, Ta = {}, na, ga, Ua = ["*/"] + ["*"];
    try {
        na = T.href
    } catch (ta) {
    ...
    c.fn.extend({
        load: function (b, e, g) {
            ...
            if (!this.length)return this;
            var a = b.indexOf(" ");
            if (0 <= a)var d = b.slice(a, b.length), b = b.slice(0, a);
            a = "GET";
            e && (c.isFunction(e) ? (g = e, e = m) : "object" == typeof e &&
            (e = c.param(e, c.ajaxSettings.traditional), a = "POST"));
            var f = this;
            return c.ajax({
                url: b, type: a, dataType: "html", data: e, complete: function (a, b, e) {
                    e = a.responseText;
                    a.isResolved() && (a.done(function (a) {
                        e = a
            ...
            return this.map(function () {
                ...
                return null == g ? null : c.isArray(g) ? c.map(g, function (a) {
                    return {name: e.name, value: a.replace(Qa, "\r\n")}
                }) : {name: e.name, value: g.replace(Qa, "\r\n")}
            }).get()
        }
    });
    ...
    c.each(["get", "post"], function (b, e) {
        c[e] = function (b, a, d, f) {
            return c.isFunction(a) && (f = f || d, d = a, a = m), c.ajax({
                type: e,
                url: b, data: a, success: d, dataType: f
            })
        }
    });
    c.extend({
        getScript: function (b, e) {
            ...
            accepts: {
                ...
                json: "application/json, text/javascript", "*": Ua
            },
            contents: {xml: /xml/, html: /html/, json: /json/},
            responseFields: {xml: "responseXML", text: "responseText"},
            converters: {"* text": f.String, "text html": !0, "text json": c.parseJSON, "text xml": c.parseXML},
            flatOptions: {context: !0, url: !0}
        }, ajaxPrefilter: r(Sa), ajaxTransport: r(Ta), ajax: function (b, e) {
            function g(b, e, g, j) {
                if (2 !== s) {
                    s = 2;
                    x && clearTimeout(x);
                    ...
                    var l, p, t, j = e;
                    if (g) {
                        var v = a, z = w, C = v.contents, D = v.dataTypes, J = v.responseFields, K, y,
                            N, Q;
                        for (y in J)y in g && (z[J[y]] = g[y]);
                        for (; "*" === D[0];)D.shift(), K === m && (K = v.mimeType || z.getResponseHeader("content-type"));
                        if (K)for (y in C)if (C[y] && C[y].test(K)) {
                            D.unshift(y);
                            break
                        }
                        if (D[0]in g)N = D[0]; else {
                            for (y in g) {
                    ...
                    if (200 <= b && 300 > b || 304 === b) {
                        ...
                        if (304 === b)j = "notmodified",
                            ...
                            var T = K.dataTypes;
                            y = {};
                            var L, F, G = T.length, U, M = T[0], R, ma, W, ua, S;
                            for (L = 1; L < G; L++) {
                                if (1 === L)for (F in K.converters)"string" == typeof F && (y[F.toLowerCase()] = K.converters[F]);
                                R = M;
                                M = T[L];
                                if ("*" === M)M = R; else if ("*" !== R && R !== M) {
                                    ma = R + " " + M;
                                    W = y[ma] || y["* " + M];
                                    if (!W)for (ua in S = m, y)if (U = ua.split(" "), U[0] === R || "*" === U[0])if (S = y[U[1] + " " + M]) {
                                        ua = y[ua];
                                        !0 === ua ? W = S : !0 === S && (W = ua);
                                        break
                                    }
            ...
            var e = e || {}, a = c.ajaxSetup({}, e), d = a.context || a, f = d !== a && (d.nodeType || d instanceof c) ? c(d) : c.event,
                h = c.Deferred(), i = c._Deferred(), k = a.statusCode || {}, n, j = {}, l = {}, r, p, B, x, v, s = 0, E, z, w = {
                    readyState: 0, setRequestHeader: function (a, b) {
                        ...
                        var b;
                        if (2 === s) {
                            if (!p)for (p = {}; b = qb.exec(r);)p[b[1].toLowerCase()] = b[2];
                            b = p[a.toLowerCase()]
                        }
                        return b === m ? null : b
            ...
            w.statusCode = function (a) {
                if (a) {
                    var b;
                    if (2 > s)for (b in a)k[b] = [k[b], a[b]]; else b = a[w.status], w.then(b, b)
                }
                return this
            };
            ...
            if (!a.beforeSend || !1 !== a.beforeSend.call(d, w, a) && 2 !== s) {
                for (z in{success: 1, error: 1, complete: 1})w[z](a[z]);
                if (B = t(Ta,
                        a, e, w)) {
                    w.readyState = 1;
            ...
            else for (var d in b)v(d, b[d], e, a);
    ...
    c.ajaxPrefilter("json jsonp", function (b, e, g) {
        ...
        if ("jsonp" === b.dataTypes[0] || !1 !== b.jsonp && (za.test(b.url) || e && za.test(b.data))) {
            var a, d = b.jsonpCallback = c.isFunction(b.jsonpCallback) ? b.jsonpCallback() :
                b.jsonpCallback, h = f[d], i = b.url, k = b.data, n = "$1" + d + "$2";
        ...
        if (!b.crossDomain || c.support.cors) {
            ...
            return {
                send: function (g, a) {
                    ...
                    if (b.xhrFields)for (i in b.xhrFields)d[i] = b.xhrFields[i];
                    ...
                    e = function (g, f) {
                        var i, k, n, j, l;
                        try {
                            if (e && (f || 4 === d.readyState))if (e = m, h && (d.onreadystatechange = c.noop, ob && delete ja[h]), f)4 !== d.readyState && d.abort(); else {
                                i = d.status;
    ...
    var Aa = {}, ea, aa, Ga = /^(?:toggle|show|hide)$/, ba = /^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i, fa, pb = [["height", "marginTop", "marginBottom", "paddingTop", "paddingBottom"], ["width", "marginLeft", "marginRight", "paddingLeft", "paddingRight"], ["opacity"]], Ba;
    c.fn.extend({
        show: function (b, e, g) {
            var a;
            ...
            for (e = 0; e < g; e++)if (b = this[e], b.style && (a = b.style.display, "" === a || "none" === a))b.style.display = c._data(b, "olddisplay") || "";
            return this
        }, hide: function (b, e, g) {
            ...
            for (b = 0; b < e; b++)this[b].style && (this[b].style.display =
                "none");
            return this
        }, _toggle: c.fn.toggle, toggle: function (b, e, g) {
            ...
            return this.filter(":hidden").css("opacity", 0).show().end().animate({opacity: c}, b, g, a)
        }, animate: function (b, e, g, a) {
            var d = c.speed(e, g, a);
            return c.isEmptyObject(b) ? this.each(d.complete,
                [!1]) : (b = c.extend({}, b), this[!1 === d.queue ? "each" : "queue"](function () {
                !1 === d.queue && c._mark(this);
                var a = c.extend({}, d), e = 1 === this.nodeType, g = e && c(this).is(":hidden"), f, h, i, k, n, j, l, r;
    ...
    c.extend({
        speed: function (b, e, g) {
            var a = b && "object" == typeof b ? c.extend({}, b) : {
    ...
    c.fx.prototype = {
        update: function () {
            ...
            var e = Ba || (setTimeout(j, 0), Ba = c.now()), g = !0, a = this.elem, d = this.options, f, h;
            if (b || e >= d.duration + this.startTime) {
                ...
                if (g) {
                    ...
                    d.hide && c(a).hide();
                    if (d.hide || d.show)for (var i in d.animatedProperties)c.style(a, i, d.orig[i]);
                    d.complete.call(a)
                }
                return !1
            }
    ...
    var Fa = /^t(?:able|d|h)$/i, Ha = /^(?:body|html)$/i;
    "getBoundingClientRect"in s.documentElement ? c.fn.offset = function (b) {
        ...
        var d = e.ownerDocument, f = d.documentElement;
        if (!g || !c.contains(f, e))return g ? {top: g.top, left: g.left} : {top: 0, left: 0};
        e = d.body;
        d = y(d);
        return {
        ...
        if (e === e.ownerDocument.body)return c.offset.bodyOffset(e);
        c.offset.initialize();
        var g, a = e.offsetParent, d = e.ownerDocument, f = d.documentElement, h = d.body;
    ...
    c.offset = {
        initialize: function () {
            var b = s.body, e = s.createElement("div"), g, a, d, f = parseFloat(c.css(b, "marginTop")) || 0;
            c.extend(e.style, {
    ...
    c.fn.extend({
        position: function () {
            if (!this[0])return null;
            var b = this[0], e = this.offsetParent(), d = this.offset(), a = Ha.test(e[0].nodeName) ? {
                top: 0,
                left: 0
            } : e.offset();
            ...
            return this.map(function () {
                for (var b = this.offsetParent || s.body; b && !Ha.test(b.nodeName) && "static" === c.css(b, "position");)b = b.offsetParent;
                return b
            })
        }
    });
    ...
    c.each(["Height", "Width"], function (b, e) {
        ...
        c.fn[d] = function (a) {
            ...
            if (c.isWindow(b)) {
                var f = b.document.documentElement["client" + e], h = b.document.body;
...
(function (f, m) {
    ...
    function w(f, n, j) {
        var l = f.getDate(), r = f.getDay(), p = f.getMonth(), f = f.getFullYear(), m = {
            d: l,
            dd: y(l),
            ddd: k[j].shortDays[r],
            dddd: k[j].days[r],
    ...
    function v(d, h) {
        ...
        function v(c) {
            ...
            f(document).bind("keydown.d", function (c) {
                ...
                if (0 <= f(r).index(h)) {
                    ...
                    var k = f("#" + C.weeks + " a"), n = f("." + C.focus), j = k.index(n);
                    n.removeClass(C.focus);
                    if (74 == h || 40 == h)j += 7; else if (75 == h || 38 == h)j -= 7; else if (76 == h || 39 == h)j += 1; else if (72 == h || 37 == h)j -= 1;
        ...
        var z = this, E = new Date, D = E.getFullYear(), C = h.css, y = k[h.lang], F = f("#" + C.root), R = F.find("#" + C.title),
            ca, V, s, $, T, c, L = d.attr("data-value") || h.value || d.val(), M = d.attr("min") || h.min, S = d.attr("max") || h.max, da, la;
        0 === M && (M = "0");
        L = l(L) || E;
        ...
        var Z = d.add(z);
        if (!F.length) {
            F = f("<div><div><a/><div/><a/></div><div><div/><div/></div></div>").hide().css({position: "absolute"}).attr("id",
                C.root);
            ...
            if (h.selectors) {
                var ha = f("<select/>").attr("id", C.month), ia = f("<select/>").attr("id", C.year);
                R.html(ha.add(ia))
            }
        ...
        var ra = F.find("#" + C.weeks), ia = F.find("#" + C.year), ha = F.find("#" + C.month);
        f.extend(z, {
            show: function (c) {
                if (!d.attr("readonly") && !d.attr("disabled") && !da) {
                    ...
                    if (!c.isDefaultPrevented()) {
                        ...
                        return /iPad/i.test(navigator.userAgent) && (k.top = k.top - f(window).scrollTop()), F.css({
                            top: k.top + d.outerHeight({margins: true}) + h.offset[0],
                ...
                $ = d;
                c = k;
                var k = (new Date(d, i, 1 - h.firstDay)).getDay(), v = (new Date(d, i + 1, 0)).getDate(), x = (new Date(d, i - 1 + 1, 0)).getDate(), w;
                if (h.selectors) {
                    ha.empty();
                ...
                var d = T + (d || 1), f = (new Date($, d + 1, 0)).getDate();
    ...
    f.tools = f.tools || {version: "1.2.6"};
    var x = [], t, r = [75, 76, 38, 39, 74, 72, 40, 37], k = {};
    t = f.tools.dateinput = {
        conf: {
            format: "mm/dd/yy",
            selectors: !1,
...
(function (f) {
    function m(p, j) {
        var l = this, m = p.add(l), x = f(window), t, r, k, d = f.tools.expose && (j.mask || j.expose), h = Math.random().toString().slice(10);
        ...
        f.extend(l, {
            load: function (i) {
                ...
                k = !0;
                d && f(r).expose(d);
                var t = j.top, z = j.left, E = r.outerWidth({margin: !0}), D = r.outerHeight({margin: !0});
    ...
    f.fn.overlay = function (p) {
        ...
        return j ? j : (f.isFunction(p) && (p = {onBeforeLoad: p}), p = f.extend(!0, {}, f.tools.overlay.conf, p), this.each(function () {
            j = new m(f(this), p);
            y.push(j);
...
(function (f) {
    function m(f) {
        var j = f.offset();
        return {top: j.top + f.height() / 2, left: j.left + f.width() / 2}
    }

    var y = f.tools.overlay, w = f(window);
    f.extend(y.conf, {start: {top: null, left: null}, fadeInSpeed: "fast", zIndex: 9999});
    y.addEffect("apple", function (p, j) {
        var l = this.getOverlay(), v = this.getConf(), x = this.getTrigger(), t = this, r = l.outerWidth({margin: !0}), k = l.data("img"), d = v.fixed ? "fixed" : "absolute";
        if (!k) {
            ...
            k = f('<img src="' + k + '"/>');
            k.css({border: 0, display: "none"}).width(r);
            f("body").append(k);
            l.data("img", k)
        }
        var h = v.start.top || Math.round(w.height() / 2), i = v.start.left || Math.round(w.width() / 2);
        x && (x = m(x), h = x.top, i = x.left);
        v.fixed ? (h -= w.scrollTop(), i -= w.scrollLeft()) : (p.top += w.scrollTop(), p.left += w.scrollLeft());
        k.css({position: "absolute", top: h, left: i, width: 0, zIndex: v.zIndex}).show();
        p.position = d;
        l.css(p);
        k.animate({
        ...
        var j = this.getOverlay().hide(), l = this.getConf(), v = this.getTrigger(), j = j.data("img"), x = {
            top: l.start.top,
            left: l.start.left,
            width: 0
        };
        v && f.extend(x, m(v));
        l.fixed && j.css({position: "absolute"}).animate({top: "+=" + w.scrollTop(), left: "+=" + w.scrollLeft()}, 0);
...
(function (f) {
    ...
    function p(j, l) {
        function r(d, c, f, i) {
            ...
            if (i || !p)f += l.min;
            p && (i ? c = E - c : f = l.max - f);
            var f = m(f, R), k = "click" == d.type;
            if ($ && void 0 !== v && !k && (d.type = "onSlide", s.trigger(d, [f, c]), d.isDefaultPrevented()))return h;
            i = k ? l.speed : 0;
            k = k ? function () {
                d.type = "change";
                s.trigger(d, [f])
            } : null;
            return p ? (D.animate({top: c}, i, k), l.progress && C.animate({height: E - c + D.height() / 2}, i)) : (D.animate({left: c}, i, k), l.progress && C.animate({width: c + D.width() / 2}, i)), v = f, j.val(f), h
        }
        ...
        var h = this, i = l.css, n = f("<div><div/><a href='#'/></div>").data("rangeinput", h), p, v, z, E;
        j.before(n);
        var D = n.addClass(i.slider).find("a").addClass(i.handle), C = n.find("div").addClass(i.progress);
        f.each(["min", "max", "step", "value"], function (d, c) {
            var f = j.attr(c);
            parseFloat(f) && (l[c] = parseFloat(f, 10))
        });
        var U = l.max - l.min, F = "any" == l.step ? 0 : l.step, R = l.precision;
        if (void 0 === R)try {
        ...
        D.drag({drag: !1}).bind("dragStart", function () {
            k();
            $ = w(f(h)) || w(j)
        ...
        l.keyboard && j.keydown(function (d) {
            if (!j.attr("readonly")) {
                var c = d.keyCode, i = -1 != f([75, 76, 38, 33, 39]).index(c), k = -1 != f([74, 72, 40, 34, 37]).index(c);
        ...
        f.extend(j[0], {stepUp: h.stepUp, stepDown: h.stepDown});
        d();
        E || f(window).load(d)
    }
    ...
    f.fn.drag = function (j) {
        return document.ondragstart = function () {
            return !1
        }, j = f.extend({x: !0, y: !0, drag: !0}, j), l = l || f(document).bind("mousedown mouseup", function (p) {
                var r = f(p.target);
                if ("mousedown" == p.type && r.data("drag")) {
                    var k = r.position(), d = p.pageX - k.left, h = p.pageY - k.top, i = !0;
                    l.bind("mousemove.drag",
                        function (f) {
                            var k = f.pageX - d, f = f.pageY - h, l = {};
                            j.x && (l.left = k);
                            j.y && (l.top = f);
    ...
    f.fn.rangeinput = function (l) {
        ...
        var l = f.extend(!0, {}, j.conf, l), m;
        return this.each(function () {
            var j =
                new p(f(this), f.extend(!0, {}, l)), j = j.getInput().data("rangeinput", j);
            m = m ? m.add(j) : j
        }), m ? m : this
    }
})(jQuery);
(function (f) {
    ...
    function y(p, j) {
        var l = this, v = p.add(l), x = p.children(), t = 0, r = j.vertical;
        w || (w = l);
        ...
        f.extend(l, {
            ...
            move: function (d, f) {
                ...
                k = r ? {top: -k.position().top} : {left: -k.position().left};
        ...
        if (j.circular) {
            var k = l.getItems().slice(-1).clone().prependTo(x), d = l.getItems().eq(1).clone().appendTo(x);
        ...
        if (j.touch) {
            ...
            x[0].ontouchmove = function (d) {
                if (1 == d.touches.length && !x.is(":animated")) {
                    var f = d.touches[0], h = B - f.clientX, f = y - f.clientY;
    ...
    f.fn.scrollable = function (p) {
        ...
        return j ? j : (p = f.extend({}, f.tools.scrollable.conf, p), this.each(function () {
            j = new y(f(this), p);
...
(function (f) {
    ...
    m.autoscroll = {conf: {autoplay: !0, interval: 3E3, autopause: !0}};
    f.fn.autoscroll = function (y) {
        "number" == typeof y && (y = {interval: y});
        var w = f.extend({}, m.autoscroll.conf, y), p;
        return this.each(function () {
            function j() {
            ...
            var l = f(this).data("scrollable"), m = l.getRoot(), x, t = !1;
            l && (p = l);
            l.play = function () {
...
(function (f) {
    ...
    f.fn.navigator = function (w) {
        "string" == typeof w && (w = {navi: w});
        var w = f.extend({}, y.navigator.conf, w), p;
        return this.each(function () {
            function j() {
            ...
            function l(d) {
                var i = f("<" + (w.naviItem || "a") + "/>").click(function (i) {
                    ...
                    v.seekTo(d);
                    i.preventDefault();
                    k && history.pushState({i: d})
                });
                return 0 === d && i.addClass(r), w.indexed && i.text(d + 1), w.idPrefix && i.attr("id", w.idPrefix + d), i.appendTo(x)
            }

            var v = f(this).data("scrollable"), x = w.navi.jquery ? w.navi : m(v.getRoot(), w.navi), t = v.getNaviButtons(), r = w.activeClass, k = w.history && !!history.pushState, d = v.getConf().size;
            v && (p = v);
            v.getNaviButtons = function () {
                return t.add(x)
            };
            k && (history.pushState({i: 0}), f(window).bind("popstate", function (d) {
...
(function (f) {
    function m(j, l, p) {
        var m = this, t = j.add(this), r = j.find(p.tabs), k = l.jquery ? l : j.children(l), d;
    ...
    var y = {
        "default": function (f, l) {
            ...
            var p = this.getConf(), m = p.fadeOutSpeed, t = this.getPanes();
    ...
    f.tools.tabs.addEffect("horizontal", function (j, l) {
        if (!w) {
            var m = this.getPanes().eq(j), x = this.getCurrentPane();
    ...
    f.fn.tabs = function (j, l) {
        ...
        return p && (p.destroy(), this.removeData("tabs")), f.isFunction(l) && (l = {onBeforeClick: l}), l = f.extend({}, f.tools.tabs.conf, l), this.each(function () {
            p = new m(f(this), j, l);
            f(this).data("tabs", p)
        }), l.api ? p : this
    }
...
(function (f) {
    function m(m, p) {
        ...
        var v = this, x = m.add(this), t = m.data("tabs"), r, k = !0, d = j(p.next).click(function () {
            t.next()
    ...
    f.fn.slideshow = function (w) {
        ...
        return p ? p : (w = f.extend({}, y.conf, w), this.each(function () {
            p = new m(f(this),
                w);
...
(function (f) {
    function m() {
        if (f.browser.msie) {
            var j = f(document).height(), l = f(window).height();
    ...
    f.mask = {
        load: function (t, r) {
            if (l)return this;
            "string" == typeof t && (t = {color: t});
            t = t || v;
            v = t = f.extend(f.extend({}, w.conf), t);
            p = f("#" + t.maskId);
            ...
            }), j = r.css({zIndex: Math.max(t.zIndex + 1, "auto" == x ? 0 : x)})), p.css({display: "block"}).fadeTo(t.loadSpeed, t.opacity, function () {
                f.mask.fit();
                y(t.onLoad);
                l = "full"
            }), l = !0, this)
...
(function () {
    function f(f, k) {
        if (k)for (var d in k)k.hasOwnProperty(d) && (f[d] = k[d]);
        return f
    }
    ...
    function y(j, k, d) {
        if (x.isSupported(k.version))j.innerHTML = x.getHTML(k, d); else if (k.expressInstall && x.isSupported([6, 65]))j.innerHTML = x.getHTML(f(k, {src: k.expressInstall}), {
    ...
    var w = document.all, p = "http://www.adobe.com/go/getflashplayer", j = "function" == typeof jQuery, l = /(\d+)[^\d]+(\d+)[^\d]*(\d*)/, v = {
        width: "100%",
        height: "100%",
    ...
    window.flashembed = function (j, k, d) {
        ...
        return !j ? void 0 : ("string" == typeof k && (k = {src: k}), new y(j, f(f({}, v), k), d))
    };
    var x = f(window.flashembed, {
        conf: v, getVersion: function () {
            var f, k;
            try {
            ...
            var j = f({}, j), d = '<object width="' + j.width + '" height="' + j.height + '" id="' + j.id + '" name="' + j.id + '"';
    ...
    j && (jQuery.tools = jQuery.tools || {version: "1.2.6"}, jQuery.tools.flashembed = {conf: v}, jQuery.fn.flashembed = function (f, k) {
        return this.each(function () {
...
(function (f) {
    function m(m) {
        switch (m.type) {
            case "mousemove":
                return f.extend(m.data, {clientX: m.clientX, clientY: m.clientY, pageX: m.pageX, pageY: m.pageY});
            case "DOMMouseScroll":
                f.extend(m, m.data);
                m.delta = -m.detail / 3;
                break;
...
(function (f) {
    function m(m, j, l) {
        var v = l.relative ? m.position().top : m.offset().top, w = l.relative ? m.position().left : m.offset().left, t = l.position[0], v = v - (j.outerHeight() - l.offset[0]), w = w + (m.outerWidth() + l.offset[1]);
        ...
        return "center" == t && (w -= m / 2), "left" == t && (w -= m), {top: v, left: w}
    }

    function y(p, j) {
        var l = this, v = p.add(l), x,
            t = 0, r = 0, k = p.attr("title"), d = p.attr("data-tooltip"), h = w[j.effect], i, n = p.is(":input"), B = n && p.is(":checkbox, :radio, select, :button, :submit"), y = p.attr("type"), z = j.events[y] || j.events[n ? B ? "widget" : "input" : "def"];
        ...
        f.extend(l, {
            show: function (n) {
                ...
                B = m(p, x, j);
                x.css({position: "absolute", top: B.top, left: B.left});
                i = !0;
                h[0].call(l, function () {
                    n.type = "onShow";
                    i = "full";
    ...
    var w = {
        toggle: [function (f) {
            var j = this.getConf(), l = this.getTip(), j = j.opacity;
            1 > j && l.css({opacity: j});
            l.show();
            f.call()
        }, function (f) {
    ...
    f.fn.tooltip = function (m) {
        ...
        return j ? j : (m = f.extend(!0, {}, f.tools.tooltip.conf, m), "string" == typeof m.position && (m.position = m.position.split(/,?\s/)), this.each(function () {
            j = new y(f(this), m);
...
(function (f) {
    ...
    m.dynamic = {conf: {classNames: "top right bottom left"}};
    f.fn.dynamic = function (y) {
        "number" == typeof y && (y = {speed: y});
        var y = f.extend({}, m.dynamic.conf, y), w = f.extend(!0, {}, y), p = y.classNames.split(/\s/), j;
        return this.each(function () {
            var l = f(this).tooltip().onBeforeShow(function (l, m) {
                var t = this.getTip(), r = this.getConf();
                j || (j = [r.position[0], r.position[1], r.offset[0], r.offset[1], f.extend({}, r)]);
                f.extend(r, j[4]);
                r.position = [j[0], j[1]];
                r.offset = [j[2], j[3]];
                t.css({
...
(function (f) {
    ...
    var y = {up: ["-", "top"], down: ["+", "top"], left: ["-", "left"], right: ["+", "left"]};
    m.addEffect("slide", function (f) {
        var m = this.getConf(), j = this.getTip(), l = m.slideFade ? {opacity: m.opacity} : {}, v = y[m.direction] || y.up;
        l[v[1]] = v[0] + "=" + m.slideOffset;
        m.slideFade && j.css({opacity: 0});
        j.show().animate(l, m.slideInSpeed, f)
    }, function (m) {
        var p = this.getConf(), j = p.slideOffset,
            l = p.slideFade ? {opacity: 0} : {}, v = y[p.direction] || y.up, x = "" + v[0];
        p.bounce && (x = "+" == x ? "-" : "+");
        l[v[1]] = x + "=" + j;
...
(function (f) {
    function m(d, h, i) {
        var k = d.offset().top, j = d.offset().left, l = i.position.split(/,?\s+/), m = l[0], l = l[1], k = k - (h.outerHeight() - i.offset[0]), j = j + (d.outerWidth() + i.offset[1]);
        /iPad/i.test(navigator.userAgent) && (k -= f(window).scrollTop());
        i = h.outerHeight() + d.outerHeight();
        "center" == m && (k += i / 2);
        "bottom" == m && (k += i);
        d = d.outerWidth();
        return "center" == l && (j -= (d + h.outerWidth()) / 2), "left" == l && (j -= d), {top: k, left: j}
    }
    ...
    function w(d, h, i) {
        ...
        var p = this, w = h.add(p), d = d.not(":button, :image, :reset, :submit");
        ...
        f.extend(p, {
            getConf: function () {
                ...
                return d.each(function () {
                    var d =
                        f(this), h = d.data("msg.el");
                    h && (d = m(d, h, i), h.css({top: d.top, left: d.left}))
                }), p
                ...
                if (!j) {
                    ...
                    f.each(h, function (f, h) {
                        ...
                        i.length && (i.trigger("OI", [h]), n.push({input: i, messages: [h]}))
                    });
                    h = n;
                    j = f.Event()
                }
                ...
                h.not(":radio:not(:checked)").each(function () {
                    var d = [], h = f(this).data("messages", d), k = l && h.is(":date") ? "onHide.v" : i.errorInputEvent + ".v";
                    h.unbind(k);
                    f.each(r, function () {
                        var f = this[0];
    ...
    f.tools = f.tools || {version: "1.2.6"};
    var p = /\[type=([a-z]+)\]/, j = /^-?[0-9]*(\.[0-9]+)?$/, l = f.tools.dateinput, v = /^([a-z0-9_\.\-\+]+)@([\da-z\.\-]+)\.([a-z\.]{2,6})$/i,
        x = /^(https?:\/\/)?[\da-z\.\-]+\.[a-z\.]{2,6}[#&+_\?\/\w \.\-=]*$/i, t;
    t = f.tools.validator = {
        conf: {
            grouped: !1,
            effect: "default",
            ...
            singleError: !1,
            speed: "normal"
        }, messages: {"*": {en: "Please correct this value"}}, localize: function (d, h) {
            f.each(h, function (f, h) {
            ...
            f.isFunction(h) ? i = h : ("string" == typeof h && (h = {en: h}), this.messages[d.key || d] = h);
            (h = p.exec(d)) && (d = y(h[1]));
            r.push([d, i])
    ...
    var r = [], k = {
        "default": [function (d) {
            ...
            f.each(d, function (d, k) {
                ...
                j = m(j, l, h);
                l.css({visibility: "visible", position: "absolute", top: j.top, left: j.left}).fadeIn(h.speed)
            })
        }, function (d) {
            var h = this.getConf();
            d.removeClass(h.errorClass).each(function () {
                var d = f(this).data("msg.el");
                d && d.css({visibility: "hidden"})
            })
        }]
    };
    ...
    f.fn.validator = function (d) {
        ...
        return h && (h.destroy(), this.removeData("validator")), d = f.extend(!0, {}, t.conf, d), this.is("form") ? this.each(function () {
            var i =
                f(this);
...
jQuery.effects || function (f, m) {
    ...
    function w() {
        var f = document.defaultView ? document.defaultView.getComputedStyle(this, null) : this.currentStyle, d = {}, h, i;
        if (f && f.length && f[0] && f[f[0]])for (var j = f.length; j--;)h = f[j], "string" == typeof f[h] && (i = h.replace(/\-(\w)/g, function (d, f) {
            return f.toUpperCase()
        }), d[i] = f[h]); else for (h in f)"string" === typeof f[h] && (d[h] = f[h]);
        return d
    }
    ...
    f.effects.animateClass = function (k, d, h, i) {
        ...
        return this.queue(function () {
            var l = f(this), m = l.attr("style") ||
                " ", r = p(w.call(this)), v, x = l.attr("class");
            ...
            l.attr("class", x);
            l.animate(j(r, v), {
                queue: false, duration: d, easing: h, complete: function () {
                    f.each(t, function (d, f) {
                        if (k[f])l[f + "Class"](k[f])
                    });
    ...
    f.fn.extend({
        _addClass: f.fn.addClass, addClass: function (k, d, h, i) {
            return d ? f.effects.animateClass.apply(this,
                [{add: k}, d, h, i]) : this._addClass(k)
        }, _removeClass: f.fn.removeClass, removeClass: function (k, d, h, i) {
            return d ? f.effects.animateClass.apply(this, [{remove: k}, d, h, i]) : this._removeClass(k)
        }, _toggleClass: f.fn.toggleClass, toggleClass: function (k, d, h, i, j) {
            return "boolean" == typeof d || d === m ? h ? f.effects.animateClass.apply(this, [d ? {add: k} : {remove: k}, h, i, j]) : this._toggleClass(k, d) : f.effects.animateClass.apply(this, [{toggle: k}, d, h, i])
    ...
    f.extend(f.effects, {
        version: "1.8.18", save: function (f, d) {
            ...
            "static" == k.css("position") ?
                (h.css({position: "relative"}), k.css({position: "relative"})) : (f.extend(d, {
    ...
    f.extend(f.easing, {
        def: "easeOutQuad", swing: function (k, d, h, i, j) {
            ...
            l || (l = j * 0.3 * 1.5);
            m < Math.abs(i) ? (m = i, f = l / 4) : f = l / (2 * Math.PI) * Math.asin(i / m);
            return 1 > d ? -0.5 * m * Math.pow(2, 10 * (d -= 1)) * Math.sin((d * j - f) * 2 * Math.PI / l) + h : 0.5 * m * Math.pow(2,
                -10 * (d -= 1)) * Math.sin((d * j - f) * 2 * Math.PI / l) + i + h
...
SpotifyRemote.Type = {DesktopClient: "desktop-client", WebPlayer: "webplayer"};
SpotifyRemote.Error = {
    TRACK_UNAVAILABLE: "4303", USER_NOT_LOGGED_IN: "4110", message: {
        4001: "Unknown method",
...
SpotifyRemote.EventTarget.prototype.applyEventCallbacks = function (a) {
    var b = this, d;
    for (d in this.events)if (this.events.hasOwnProperty(d)) {
        var c = this.getCallbackName(d), e = "add" + c, g = "remove" + c.replace(/^on/i, "");
        (function (c) {
...
SpotifyRemote.EventTarget.prototype.unsubscribe = function (a, b) {
    for (var d = this.events[a], c = d.length - 1; c >= 0; --c)if (d[c] === b) {
        d.splice(c, 1);
        return true
    }
    return false
...
SpotifyRemote.EventTarget.prototype.dispatch = function (a, b, d) {
    if (this.events[a])for (var d = d || this, b = b instanceof Array ? b : [b], c, e = 0, g = this.events[a].length; e < g; e++) {
        c = this.events[a][e];
        c.apply(d, b)
    }
};
...
SpotifyRemote.web.config = {clientUrl: "https://play.spotify.com"};
...
SpotifyRemote.web.localStorageMessages = function () {
    function a(a) {
        var e = a.key;
        if (d[e] && document.location.href !== a.url)for (var a = b(a.newValue), h = 0, f = d[e].length; h < f; h++) {
            c = d[e][h];
    ...
    function b(a, b) {
        var c = "";
        try {
            var d = JSON.parse(a), c = b ? JSON.stringify(d.data) : d.data
        } catch (e) {
        }
        return c
    }
    ...
    return {
        send: function (a, b) {
            ...
            b.reason = "remote";
            if (e)try {
                var d = {timestamp: Date.now(), data: b};
            ...
            if (e) {
                void 0 === d[a] && (d[a] = []);
                d[a].push({fn: b, args: c, context: f})
            }
        }, detach: function (a, b) {
            if (e && typeof d[a] !== "undefined" && d[a].length > 0)for (var c = 0, f = d[a].length, o = null; c < f; c++) {
                o =
                    d[a][c];
                if (o.fn == b) {
                    d[a].splice(c, 1);
...
SpotifyRemote.init = function (a, b, d, c) {
    ...
    var f = null;
    e = g = null;
    var o = b ? b : null, t = SpotifyRemote.settings.extend({
        allowPopUp: true,
        shouldUseWebPlayer: false
    }, c || {}), s = false, p = new SpotifyRemote.EventTarget, u = d;
    (function () {
        setTimeout(function () {
            if (f ===
                null) {
                SpotifyRemote.isDev() && console.log("client remote loaded");
                g = SpotifyRemote.desktop.remote(p, {
                    oauthToken: a,
                    fbAuthToken: o,
                    allowPopup: t.allowPopUp
                }, {port: void 0, subdomain: void 0});
            ...
            window.setTimeout(function () {
                if (t.shouldUseWebPlayer && (f === null || !f.isClientRunning())) {
                    ...
                    f = e = SpotifyRemote.web.remote(p, {oauthToken: a, fbAuthToken: o, allowPopup: t.allowPopUp});
                    h()
                }
            }, 400)
        }, 0)
    ...
    b = {
        events: p.events, playPauseTrack: function (a,
                                                    b, c) {
        ...
        openSpotifyURI: function (a, b) {
            ...
            for (var b in a)a.hasOwnProperty(b) && p.subscribe(b, a[b])
        }, addOnClientConnectedListener: function (a) {
            var b =
                this;
            p.subscribe(this.events.onclientconnected, function () {
                b.updateActiveClient();
                typeof a === "function" && a()
            })
        }, updateActiveClient: j
    };
    return b = p.applyEventCallbacks(b)
};
"SpotifyRemote"in window || (window.SpotifyRemote = {});
...
SpotifyRemote.desktop.utils = {
    _enabled: !0, disable: function () {
        ...
        var e = SpotifyRemote.desktop.utils.baseUrl() + ":" + a + "/service/version.json?service=remote", g = SpotifyRemote.desktop.config.subdomain;
        SpotifyRemote.desktop.utils.ajax({
            url: e, success: function (b) {
                d && d(b, a, g)
            }, error: function (e) {
...
SpotifyRemote.desktop.base = function () {
    var a = SpotifyRemote.desktop.config, b = a.startingPort, d = a.endingPort;
    return {
...
SpotifyRemote.desktop.remote = function (a, b, d) {
    ...
    function g() {
        q && y({
            url: h("remote/login.json", {csrf: x, oauth: q}), success: function (a) {
    ...
    function f(a) {
        y({
            url: h("simplecsrf/token.json"), success: function (b) {
                SpotifyRemote.isDev() && console.log("csrf successful");
                x = b.token;
                k.dispatch(k.events.onclientconnected, {running: !D});
                a && a(true)
            }, error: function () {
    ...
    function p() {
        n !== "" && y({
            url: h("remote/play.json", {csrf: x, oauth: w.oauthToken, uri: n, context: z}),
            success: function (a) {
    ...
    function u() {
        n !== "" && y({
            url: h("remote/queue.json", {csrf: x, oauth: w.oauthToken, uri: n, context: z}), success: function (a) {
    ...
    function C(a) {
        ...
        n = "";
        y({
            url: h("remote/pause.json", {pause: a, csrf: x, oauth: w.oauthToken}), success: function (a) {
                F(a)
            }
        })
    }
    ...
    function K() {
        y({
            url: h("remote/open.json"), success: function (a) {
                if (a.running) {
                    D = false;
                    m()
                }
    ...
    function N(a) {
        ...
        y({
            url: h("remote/volume.json", {volume: a, csrf: x, oauth: w.oauthToken}),
            success: function (a) {
    ...
    function O(a) {
        var a = function (a) {
            var b = Math.floor(a / 60), a = (a % 60).toFixed(3);
            return b + ":" + a
        }(a), b = r ? r.track_resource.uri : null;
        b && a && y({
            url: h("remote/play.json", {csrf: x, oauth: w.oauthToken, uri: b + "#" + a, context: z}),
            success: function (a) {
    ...
    var d = d || {}, w = b || {}, b = SpotifyRemote.desktop.utils, x = "", q = w.fbAuthToken || null, v = d.port || SpotifyRemote.desktop.config.startingPort;
    d.subdomain || b.randomString();
    var n = "", z = "", B = false, E = false, M = false, A = d.port && d.subdomain, J = false, r = null, H = true, I = false, Q = 2, R = 90, S = 5E3, G, D = false, y = b.ajax, P = b.baseUrl, L = null, k = a || new SpotifyRemote.EventTarget, F = function () {
        function a() {
            b = null;
            if (!c || !c.track && r)c = {track: r, playing: false};
            c.track && c.track.track_resource.uri === (r ? r.track_resource.uri : null) && k.dispatch(k.events.playpositionchanged, {value: c.playing_position});
            if (c.track) {
                J = c.playing;
                k.dispatch(k.events.playmodechanged, {
                    track: c.track, status: J,
...
SpotifyRemote.web.remote = function (a) {
    function b() {
        t && (o ? f && f.track_resource.uri == j ? d(!s) : d(true) : u || (u = setInterval(c, K)))
    }

    function d(a) {
        a = {track: j, context: h, play: a, time: Date.now()};
        SpotifyRemote.isDev() && console.log("[SPB play-pause]", a);
        q.send(v.STATUS_FROM_REMOTE, a)
    }

    function c() {
        SpotifyRemote.isDev() && console.log("[SPB try to connect...]");
        if (o)SpotifyRemote.isDev() && console.log("[SPB already connected...]"); else {
            q.send(v.CONNECT_REQUEST_FROM_REMOTE);
            p++;
            if (p > C) {
                clearInterval(u);
                u = null;
    ...
    function e(a) {
        if (typeof a.error !==
            "undefined") {
            a = {type: x[a.error], message: a.message, uri: typeof a.uri !== "undefined" ? a.uri : ""};
            ...
            n({
                track: {
                    track_resource: {uri: a.track},
                    artist_resource: {uri: a.track},
                    album_resource: {uri: a.track}
                },
    ...
    var j = "", h = "", f = null, o = false, t = false, s = false, p = 0, u, C = 30, K = 2E3, m = a || new SpotifyRemote.EventTarget, N = "STATUS_MESSAGE", O = "CLIENT_CONNECTED", w = "CLIENT_DISCONNECTED", x = {unplayable: "4303"}, q = SpotifyRemote.web.remoteMessages.init(), v = SpotifyRemote.web.remoteMessages.messages, n = function () {
        function a() {
            SpotifyRemote.isDev() && console.log("dispatch playmodechanged",
                c);
            b = null;
            if (!c || !c.track && f)c = {track: f, playing: false};
            if (c.track) {
                s = c.playing;
    ...
    setTimeout(function () {
        ...
        q.listen(v.STATUS_TO_REMOTE, e);
        q.listen(v.CONNECTED, g)
    }, 500);
    return {
        disable: function () {
            q.detach(v.STATUS_TO_REMOTE, e);
            q.detach(v.CONNECTED, g)
        }, getIdentifier: function () {
...
var seekerInterval, currentTrack, animations = [], animationRunning = !1, copyLinkSelectedAtLeastOnce = !1, embedCodeSelectedAtLeastOnce = !1, downloadViewShowedAtLeastOnce = !1, emailRegViewShowedAtLeastOnce = !1, mode = "mode-compact", ANIMATION_TYPE_SLIDE_LEFT = 0, ANIMATION_TYPE_SLIDE_RIGHT = 1, PLAYER_HEIGHT = 80, PLAYER_MIN_WIDTH = 210, ENGAGEVIEW_MIN_HEIGHT = 209, BORDER_THICKNESS = 1, DOUBLE_BORDER_THICKNESS = 2, HTTP_SPOTIFY_OPEN_BASE = "http://open.spotify.com";
...
function resizeWidget() {
    var a = $(window).width(), b = $(window).height(), d = $("body"), c, e;
    ...
    a >= PLAYER_MIN_WIDTH && b >= ENGAGEVIEW_MIN_HEIGHT + PLAYER_HEIGHT ? (mode = "mode-large", $("#outerWidgetContainer").css({
        width: e,
        height: c
    })) : (mode = "mode-compact", $("#outerWidgetContainer").css({width: "auto", height: "100%"}));
...
function _populateShareInfo() {
    var a = "https://" + document.location.host + "/?uri=" + dataContext, b = $("#widgetContainer").width(), d = $("#widgetContainer").height();
...
function updateStatusBar(a) {
    ...
    $(".player .album-art-container .album-art .art").attr("src") != a.attr("data-small-ca") && ($(".player .album-art-container .album-art .art").attr("src", defaultCoverImg), $(".player .album-art-container .album-art .art").attr("src", a.attr("data-small-ca")));
    switch (b) {
        case 0:
            _changeStatus("left", "disable");
            _changeStatus("right", "enable");
            break;
...
function setAlbums(a) {
    ...
    for (b in a)a.hasOwnProperty(b) && (a[b] ? $(".cover-art-container ." + b + " .album-art").attr("src", a[b]) : $(".cover-art-container ." + b + " .album-art").attr("src", defaultCoverImg))
}
...
function getTrackGivenOffset(a, b) {
    var d = a.parent().children(), c = d.length - 1, e = +a.attr("data-index"), g = 0 === e ? -1 : e - 1, c = e == c ? -1 : e + 1;
...
function l(a) {
    $.ajax({url: "/l/?t=" + a + "&" + getViewPlayerString() + "&ref=" + encodeURIComponent(frameReferrer)})
}
function getView() {
...
function Get_Cookie(a) {
    var b = document.cookie.split(";"), d = "", c = "", e = "";
    for (i = 0; i < b.length; i++)if (d = b[i].split("="), c = d[0].replace(/^\s+|\s+$/g, ""), c == a)return 1 < d.length && (e = unescape(d[1].replace(/^\s+|\s+$/g, ""))), e;
    return null
}
(function () {
    var a = jQuery.event.special, b = "D" + +new Date, d = "D" + (+new Date + 1);
    a.scrollstart = {
        setup: function () {
            var c, d = function (b) {
                var d = arguments;
...
$(".submitEmail").click(function (a) {
    ...
    "" !== a && ($.ajax({url: "/l/?t=10&email=" + a + "&ref=" + encodeURIComponent(frameReferrer) + "&" + getViewPlayerString()}), closeOverlay());
    return !1
});
...
(function (a) {
    function P(x) {
        var c = x || window.event, h = [].slice.call(arguments, 1), m = 0, T = 0, M = 0, x = a.event.fix(c);
        x.type = "mousewheel";
    ...
    if (a.event.fixHooks)for (var m = h.length; m;)a.event.fixHooks[h[--m]] =
        a.event.mouseHooks;
    a.event.special.mousewheel = {
        setup: function () {
            if (this.addEventListener)for (var a = h.length; a;)this.addEventListener(h[--a], P, !1); else this.onmousewheel = P
        }, teardown: function () {
            if (this.removeEventListener)for (var a = h.length; a;)this.removeEventListener(h[--a], P, !1); else this.onmousewheel = null
        }
    };
    a.fn.extend({
        ...
        function x(c, m) {
            function x(b) {
                ...
                if (e === h)o = c.scrollTop(), j = c.scrollLeft(), c.css({
                    ...
                    width: n + "px",
                    height: k + "px"
                }).append(e).appendTo(c); else {
                    c.css("width", "");
                    D = d.stickToBottom && ua();
                    l = d.stickToRight && va();
                    if (i = c.innerWidth() + N != n || c.outerHeight() !=
                            k)n = c.innerWidth() + N, k = c.innerHeight(), g.css({width: n + "px", height: k + "px"});
                ...
                if (!w && !y)c.removeClass("jspScrollable"), e.css({
                    ...
                    "-1").removeAttr("tabindex").unbind("keydown.jsp keypress.jsp"), oa(), pa(); else {
            ...
            function wa() {
                if (w && y) {
                    var b = B.outerHeight(), f = A.outerWidth();
                    I -= b;
            ...
            function Da(b, f, c, i) {
                var c = a(c).addClass("jspActive"), o, j, D = !0, e = function () {
            ...
            function Ba() {
                ...
                y && A.bind("mousedown.jsp", function (b) {
                    if (b.originalTarget === h || b.originalTarget == b.currentTarget) {
                        var f = a(this), c = f.offset(), i = b.pageY - c.top - q, o, j = !0, D = function () {
                            var a = f.offset(), a = b.pageY - a.top - L / 2, c = k * d.scrollPagePercent, p = C * c / (s - k);
                            if (0 > i)q - p > a ? l.scrollByY(-c) : O(a); else if (0 < i)q + p < a ? l.scrollByY(c) : O(a); else {
                                e();
                                return
                            }
                ...
                w && B.bind("mousedown.jsp", function (b) {
                    if (b.originalTarget === h || b.originalTarget == b.currentTarget) {
                        var f = a(this), c = f.offset(), i = b.pageX - c.left - r, o, j = !0, e = function () {
                            var a = f.offset(), a = b.pageX - a.left - J / 2, c = n * d.scrollPagePercent, p = K * c / (t - n);
                            if (0 > i)r - p > a ? l.scrollByX(-c) : S(a); else if (0 < i)r + p < a ? l.scrollByX(c) : S(a); else {
                                g();
                                return
                            }
            ...
            function ja(b) {
                ...
                g.scrollTop(0);
                r = b;
                var a = 0 === r, p = r == K, b = -(b / K) * (t - n);
                if (ea != a || fa != p)ea = a, fa = p, c.trigger("jsp-arrow-change",
                    [ca, da, ea, fa]);
            ...
            function Y(b, f, c) {
                ...
                b = i.outerWidth();
                g.scrollTop(0);
                for (g.scrollLeft(0); !i.is(".jspPane");)if (j += i.position().top, e += i.position().left, i = i.offsetParent(), /^body|html$/i.test(i[0].nodeName))return;
                i = F();
                l = i + k;
            ...
            function za() {
                ...
                g.unbind("touchstart.jsp touchmove.jsp touchend.jsp click.jsp-touchclick").bind("touchstart.jsp", function (g) {
                    ...
                    if (j) {
                        var g = g.originalEvent.touches[0], h = r, k = q;
            ...
            var d, l = this, e, n, k, g, t, s, ga, Z, y, w, u, C, q, v, K, r, aa, A, ia, I, L, U, V, ba, B, z, J, W, X, $, ma, N, na, ca = !0, ea = !0, da = !1, fa = !1, la = c.clone(!1, !1).empty(), ha = a.fn.mwheelIntent ? "mwheelIntent.jsp" : "mousewheel.jsp";
            ...
            a.extend(l, {
                ...
                animate: function (a, c, e, g) {
                    var h = {};
                    h[c] = e;
                    a.animate(h, {duration: d.animateDuration, easing: d.animateEase, queue: !1, step: g})
...
var SPR, fbBridge, seekerInterval, durationTimer, trackId = null, clickedTrack, utilFrame, iHaveSpotifyClickedAtLeastOnce = !1, installTutorial, MacOS = "MacOS", WindowsOS = "WindowsOS", OSName = WindowsOS;
-1 != navigator.appVersion.indexOf("Mac") && (OSName = MacOS);
PlayButtonStatus = {seekerInitialized: !1};
function initIntructionSlider() {
    var c = MacOS;
    OSName == MacOS && (c = WindowsOS);
    $(".items." + c).remove();
    $("#instructionBrowse").scrollable({circular: !0, mousewheel: !1}).navigator().autoscroll({interval: 3E3});
    $("#instructionBrowse").scrollable().stop()
}
...
function oldCheck() {
    ...
    Spotify.Tracking.send({category: "launch-client", action: c, value: ""}, !0)
}
function checkClientConnected() {
    ...
    }), Spotify.Tracking.send({category: "launch-client", action: "webplayer", value: ""}, !0)) : oldCheck()
}
function triggerPlayPause(c, b, a) {
    b && b.preventDefault();
    Spotify.Tracking.send({category: "remote-control", action: "play-clicked", value: SPR.getIdentifier()}, !0);
    clickedTrack = c;
...
function handlePlayerStatus(c, b, a) {
    var d = $(".player"), j = $("#engageView"), f = $(".track-" + c);
...
function initializeSeeker(c, b, a) {
    ...
    var f = +$(".track-" + c).attr("data-duration-ms"), e = 500 / f;
...
function changePlayModeForTrack(c) {
    ...
    0 < b.length ? ($(".active").removeClass("active"), b.attr("class", a ? "track-" + trackId + " music-playing active item " + contextType : "track-" + trackId + " music-paused active item " + contextType), b.each(function (a, b) {
        ...
        action: "client-playing", value: SPR.getIdentifier()
    }, !0))) : clearIntervals()
}
function onClientConnected() {
    ...
    Spotify.Tracking.send({category: "remote-control", action: "client-connected", value: SPR.getIdentifier()}, !0)
}
function onClientError(c) {
    showNotificationBar(c.message);
    "4303" == c.type && $(".track-" + c.uri.split(":")[2]).addClass("unavailable");
    Spotify.Tracking.send({category: "remote-control", action: "client-error", value: SPR.getIdentifier()}, !0)
}
function setupSpotifyRemote() {
    ...
    Spotify.Webplayer.prefetch()
}
ConnectionCounter = {
    _counter: 0, _logged: !1, increase: function () {
...
function showInstallGuide() {
    var c = "?ref=" + encodeURIComponent(frameReferrer) + "&t=" + testLeg, b = (screen.width - 973) / 2, a = (screen.height - 400) / 2;
...
$(document).ready(function () {
    ...
    fbBridge.connect({appId: Spotify.Config.get("fb-app-id")}, function () {
    })
});
...
Array.prototype.indexOf || (Array.prototype.indexOf = function (c, b) {
    var a = this.length, d = Number(b) || 0, d = 0 > d ? Math.ceil(d) : Math.floor(d);
    for (0 > d && (d += a); d < a; d++)if (d in this && this[d] === c)return d;
    return -1
});
    ...
    c.BrowserDetect = {
        ...
        _searchString: function (b) {
            for (var a = 0; a < b.length; a++) {
                var d = b[a].string, c = b[a].prop, f = b[a].subString;
                this.versionSearch = b[a].versionSearch || b[a].identity;
                if (d) {
                    if ("string" === typeof f && -1 != d.indexOf(f) || "object" === typeof f && -1 != d.search(f))return b[a].identity
                } else if (c)return b[a].identity
            }
        },
        _searchVersion: function (b) {
            var a = this.versionSearch, d = -1;
        ...
        dataBrowser: [{
        ...
        }, {string: navigator.userAgent, subString: "OmniWeb", versionSearch: "OmniWeb/", identity: "OmniWeb"},
            {
                ...
                string: navigator.userAgent, subString: /MSIE|Trident/i,
                identity: "Explorer", versionSearch: /MSIE|rv:/i
            }, {
                string: navigator.userAgent,
                subString: "Gecko",
                identity: "Mozilla",
...
Spotify = function (c) {
    c.Config = {
        _configuration: {
            ...
            "open-url": "http://open.spotify.com/",
            ...
            "registration-module-browser-versions": {
                firefox: 14,
                chrome: 21, safari: 5, explorer: 8
            },
            "link-enabled": !0,
            "link-browser-versions": {chrome: 21, firefox: 14, safari: 5, explorer: 9},
            "embedded-player-versions": {chrome: 21, firefox: 14, safari: 5, explorer: 9},
            "mediabar-browser-versions": {chrome: 21, firefox: 14, safari: 5, explorer: [9, 10]},
            "mediabar-platforms": ["Windows", "Mac", "Linux", "Unknown"],
            "play-now-markets": [],
            "download-links": {
                windows: {"default": "https://d1clcicqv97n4s.cloudfront.net/SpotifySetup.exe"}, mac: {
                    "default": "https://d1clcicqv97n4s.cloudfront.net/Spotify.dmg",
                    app: "https://d1clcicqv97n4s.cloudfront.net/SpotifyInstaller.zip"
                }
            },
            "prefetch-webplayer-url": "https://embed.spotify.com/webplayer/",
            "spotify-target-origin": "https://embed.spotify.com",
            "allowed-origins": [["*.spotify.com", "https"], ["*.yahoo.com", "http|https"], "https://d1tgm0mcw6tx0m.cloudfront.net", "https://d34f388hvlfgq4.cloudfront.net", "https://d20nan3osubr3.cloudfront.net", ["*.last.fm", "http|https"], ["*.lastfm.de", "http|https"], ["*.lastfm.fr", "http|https"], ["*.lastfm.se", "http|https"], ["*.lastfm.pt",
                "http|https"], ["*.lastfm.pl", "http|https"], ["*.lastfm.it", "http|https"], ["*.lastfm.com.br", "http|https"], ["*.lastfm.tr", "http|https"], ["*.lastfm.jp", "http|https"], ["*.lastfm.es", "http|https"], ["*.lastfm.ru", "http|https"], ["*.lastfm.ch", "http|https"], ["*.lastfm.at", "http|https"], ["*.lastfm.com.tr", "http|https"], ["*.lastfm.biz", "http|https"], ["*.coachella.com", "http|https"], ["*.bop.fm", "http|https"], ["*.sandpit.us", "http|https"], ["*.echonest.com", "http|https"], ["*.musixmatch.com", "http|https"], ["*.undrtone.com",
                "http|https"]],
            "ab-testing": {
                "play-now-performance": {
                    A: {range: [0, 24], description: "No prefetch, no autoplay"},
                    B: {range: [25, 49], description: "Only prefetch"},
                    C: {range: [50, 74], description: "Only autoplay"},
                    D: {range: [75, 100], description: "Prefetch and autoplay"}
                },
                "animated-play-count": {
                    "no-animated": {range: [0, 0], description: "No animation updating playcount"},
                    animated: {range: [0, 100], description: "Animated playcount update"}
                }
            }
        }, set: function (b, a) {
...
Spotify = function (c) {
    ...
    c.Util = {
        _isYUILoaded: function () {
            ...
            for (var c = d.getElementsByTagName("*"), e = 0; e < c.length; e++)if (c[e].getAttribute("class"))for (var g = c[e].getAttribute("class").split(" "), h = 0; h < g.length; h++)g[h].toLowerCase() == a.toLowerCase() && b.push(c[e]); else if (c[e].className) {
                g =
                    c[e].className.split(" ");
            ...
            var c = Spotify.BrowserDetect.browser.toLowerCase(), e = Spotify.BrowserDetect.version, g = Spotify.Config.get(a);
            ...
            if (this._isJQueryLoaded() && !h)e = {
            ...
            }, "undefined" !== typeof c && (e.timeout = c), $.ajax(e); else if (h) {
                var i = new XDomainRequest, e = [], c = function () {
                    try {
                ...
                i.onload = c;
                i.onerror = c;
                if (d instanceof Object)for (var m in d)d.hasOwnProperty(m) && e.push(encodeURIComponent(m) + "=" + encodeURIComponent(d[m]));
            ...
            var a = 0, d = 0, b = d = a = 0, c = 0;
            if (window.innerWidth && window.outerHeight)a = window.innerWidth, d = window.innerHeight, b = window.outerWidth,
                c = window.outerHeight; else if (document.documentElement.clientWidth)try {
                var e = document.documentElement.clientWidth, g = document.documentElement.clientHeight;
                window.resizeTo(e, g);
                var b = e - document.documentElement.clientWidth, c = g - document.documentElement.clientHeight, h = e + b, i = g + c;
                window.resizeTo(h, i);
            ...
            var d =
                a / 1E3 / 60, a = Math.floor(d), d = Math.round(60 * (d - a));
            60 == d && (a++, d = 0);
            return 10 > d ? a + ":0" + d : a + ":" + d
        }, pageTitle: function () {
            var a = "", d = document.getElementsByTagName("title");
            ...
            return setInterval(function () {
                var e = (new Date).getTime() - b.getTime() + c, g = parseInt(e / d) * d;
                c = e % d;
                a(g);
                b = new Date
            }, d)
...
Spotify = function (c) {
    c.Url = {
        read: function (b) {
            var a = {};
            if ("undefined" === typeof b)b = window.location.search.substr(1); else {
            ...
            if (b) {
                ...
                for (d = 0; d < b.length; d++) {
                    ...
                    -1 === f ? a[decodeURIComponent(c)] = "" : a[decodeURIComponent(c.substr(0, f))] = decodeURIComponent(c.substr(f + 1))
                }
            }
            return a
        }, generate: function (b, a, d) {
            var a = this.queryFromObject(a), c = "", c = (d || location.protocol) + b;
            "" !== a && (c += "?" + a);
            return c
...
Spotify = function (c) {
    c.View = {
        render: function (b, a) {
            ...
            var d = document.createElement(b.type), d = this.includeAttributes(d, b, a);
            ...
            switch (b.split(".").pop().toLowerCase()) {
                case "css":
                    a = this.render("css-node", {href: b});
                    break;
                case "js":
                    a = this.render("js-node", {src: b})
            }
            return a
            ...
            if ("undefined" !== typeof b)for (var d in b)b.hasOwnProperty(d) && a.setAttribute(d, b[d]);
            return a
            ...
            "base-popup": {
                type: "div",
                attributes: {"class": "spotify-popup"},
                randomId: !0,
                children: [{attributes: {"class": "spotify-dialog"}, type: "div"}]
            },
            "js-node": {
                type: "script",
            ...
            iframe: {type: "iframe"},
            "css-node": {type: "link", attributes: {rel: "stylesheet", type: "text/css"}},
            loader: {type: "div", attributes: {"class": "spotify-throbber-small"}},
            "loader-big": {type: "div", attributes: {"class": "spotify-throbber-big"}},
            "iframe-share": {type: "iframe", attributes: {frameborder: 0, allowtransparency: !0}}
        }
    };
    return c
}(Spotify || {});
Spotify = function (c) {
    c.ABTest = {
        model: function (b) {
            ...
            var a = [], d = Spotify.Config.get("ab-testing");
            if (null !== d && "undefined" !== typeof d[b]) {
                var c = this.model(b), b = d[b], f;
    ...
    c.ABTest.Model = function (b, a) {
        ...
        this.isActive = function (a, b) {
            var c = !1;
            if ("[object Array]" === Object.prototype.toString.call(a))for (var e = 0; e < a.length; e++) {
        ...
        this.UID = function () {
            var a = 0, b = Spotify.Cookie.get("spu");
...
Spotify = function (c) {
    ...
    var b = function (a) {
        ...
        var b = a.target || window.parent, j = a.targetOrigin || "*", f = function (a, b, d) {
            a ===
        ...
        this.attachSendToChildren = function (a) {
            ...
            for (f in c.Message)if (c.Message.hasOwnProperty(f)) {
                var j = this.getCallbackName(c.Message[f]);
                a[j] = d
            }
        };
        this.send = function (a, c, h, i, m) {
            if (Spotify.Util.isPostMessageCompatible())if ("undefined" === typeof c && (c = {}), "undefined" === typeof m && (m = !0), "undefined" === typeof c.unique && (c.unique = Spotify.Util.randomId()), "undefined" === typeof c.propagate && (c.propagate = m), "undefined" === typeof h && (h = b), a = {
                    key: a,
                    data: c
                }, i)for (i = 0; i < h.length; i++)f(h[i], a, j); else f(h, a, j)
        };
    ...
    c.Publisher =
    {
        instance: null, getInstance: function (a) {
...
Spotify = function (c) {
    c.Popup = function (b) {
        ...
        var g = function () {
            var a = Spotify.View.render("iframe", {src: d.iframeSrc});
            ...
            if (d.sourceElement) {
                var b =
                    Spotify.Util.size(d.sourceElement), c = Spotify.Util.position(d.sourceElement), a = -1 * (a[0] / 2 - b[0] / 2), b = d.sourceElement.offsetHeight;
                if (d.offset) {
                    a = a + d.offset[0];
                    b = b + d.offset[1]
                }
                Spotify.Util.setPosition(e, {x: c.x + a, y: c.y + b})
            } else if (a) {
        ...
        (function () {
            if (f = Spotify.View.render("base-popup")) {
                var a = null;
                if (d.iframeSrc)a =
                    g(); else if (d.view)a = Spotify.View.render(d.view); else if (d.template) {
                    a = d.template;
                ...
                if (typeof d.actions === "object" && d.actions !== null) {
                    for (var b in d.actions)if (typeof d.actions[b] === "function" && b !== "onRender") {
                        a = null;
...
Spotify = function (c) {
    c.Tracking = {
        TIMEOUT: 2E3, send: function (b, a) {
            var d = !1;
            "undefined" === typeof a ? a = !1 : (a = a && window._gaq, !a && "function" === typeof ga && (d = !0));
            this.isEnabled() && (!a && !d && Spotify.Util.ajax("../l/", b, void 0, this.TIMEOUT), d ? ga("send", "event", b.category, b.action, b.label || "", b.value || 1) : _gaq.push(["_trackEvent", b.category, b.action, b.value, 0, !0]), Spotify.Logger.log("Tracking step ", b))
        }, isEnabled: function () {
            return Spotify.Config.get("tracking")
        }
    };
    c.Tracking.EventTimer = {
        _timeEvents: {}, timestamp: function () {
            return (new Date).getTime()
        },
        add: function (b) {
            "undefined" === typeof this._timeEvents[b] && (this._timeEvents[b] = {start: this.timestamp()})
        }, has: function (b) {
...
Spotify = function (c) {
    c.ShareGenerator = {
        iframe: function () {
            ...
            return Spotify.View.renderAsText("iframe-share", {width: 428, height: 100, src: b})
        }, link: function () {
            var b = Spotify.ContextConfig.url;
            return b = this.addTrackingParameters(b, "link")
        }, addTrackingParameters: function (b, a) {
            var d = "embed" === a ? "share_embed" : "share_link", d = "utm_source=" + encodeURIComponent("spb2") + "&utm_campaign=" + encodeURIComponent(d);
...
Spotify = function (c) {
    var b = {
        INSTALLER_APP: "app", INSTALLER_DEFAULT: "default", windows: function () {
    ...
    c.Download = new function () {
        var a = function (a, b) {
            var d = "", c = Spotify.BrowserDetect.OS.toLowerCase();
        ...
        this.getInstallerType = function (a) {
            Spotify.BrowserDetect.initialized || Spotify.BrowserDetect.init();
            var d = this.INSTALLER_DEFAULT, c = Spotify.BrowserDetect.OS.toLowerCase();
            "undefined" !== typeof a[c] && "function" === typeof b[c] && (d = b[c](a[c]));
            return d
        };
        this.getInstallerLink = function () {
            var b = Spotify.Config.get("download-links"), d =
...
Spotify = function (c) {
    c.PlayNow = {
        Context: {MEDIABAR: "mediabar", SPB: "spb", ENTITY: "entity"}, isEnabled: function (b, a) {
            ...
            switch (b) {
                ...
                case this.Context.MEDIABAR:
                case this.Context.ENTITY:
                    a = "music.yahoo.com", d = document.referrer
            }
            return [a, d]
    ...
    c.Prefetch = {
        inject: function (b) {
            ...
            if ("undefined" !== typeof b && null !== a) {
                ...
                var d = document.getElementsByTagName("head")[0], c = document.createElement("link");
                c.rel = a;
                c.href = b;
                d.appendChild(c)
            }
...
Spotify = function (c) {
    c.MetadataService = {
        _fetch: function (b, a) {
            $.ajax({
                url: "./xhr/get-info.php?uri=" + encodeURIComponent(b), success: function (b) {
                    a && a(b)
                }
            })
        }, get: function (b, a) {
...
Spotify = function (c) {
    var b = {
        "default": {source: "embed.spotify.com", campaign: "spb", medium: "spb"},
        "music.yahoo.com": {source: "music.yahoo.com", campaign: "yahoo", medium: "bd_partner"},
        "last.fm": {source: "last.fm", campaign: "lastfm", medium: "bd_partner"},
        "coachella.com": {source: "coachella.com", campaign: "coachella", medium: "bd_partner"}
    };
    c.Webplayer = {
        getValidUrl: function (a) {
            "spotify:" === a && (a = "");
            if ("" !== a)if (a = a.split(":"), "trackset" === a[1])var b = "" !== a[2] ? a[2] : "default", c = a[3].replace("#", "/%23/"), a = a[1] + "/" +
                encodeURIComponent(b) + "/" + c; else a = a.splice(1).join("/");
            ...
            }, f = this.getValidUrl(c.uri), f = this.addParameters(f, c);
            Spotify.isLinkSpotified() || !c.checkIsLinkSpotified ? (c = window.open(f), Spotify.WebplayerInspect.inspectWindowStatus(c)) :
                $.ajax({
                    ...
                    data: {token: Spotify.Util.getChallengeToken()},
                    success: function (a) {
            ...
            if (!Spotify.isSpotified() && this.isCompatible()) {
                var a = Spotify.Config.get("prefetch-webplayer-url");
                Spotify.Prefetch.inject(a)
            }
        }, getUrl: function (a) {
            var b = "", c = Spotify.Config.get("link-url");
            "/" !== c[c.length - 1] && (c += "/");
            b = c;
...
Spotify = function (c) {
    c.WebplayerInspect = {
        _window: null, _windowStatusListeners: [], _statusInterval: null, isEnabled: function () {
            Spotify.BrowserDetect.init();
            return "explorer" === Spotify.BrowserDetect.browser.toLowerCase() && 9 === Spotify.BrowserDetect.version
        }, _notifyListeners: function () {
            for (var b = 0; b < this._windowStatusListeners.length; b++)if ("function" === typeof this._windowStatusListeners[b])this._windowStatusListeners[b]();
            this.disable()
...
Spotify = function (c) {
    ...
    c.Fb = function () {
        var b = null, a = Spotify.FbStatus.DISCONNECTED, c = null, j = Spotify.Logger, f = function (a, c, d) {
            b = b || window.FB;
            b.init({
                appId: a.appId,
        ...
        this.connect = function (a, c) {
            ...
            if (b)e(c, c); else {
                var d = Spotify.View.renderResource("//connect.facebook.net/en_US/all.js");
...
Spotify = function (c) {
    c.Cookie = {
        get: function (b) {
            for (var a = document.cookie.split(";"), c = "", j = "", f = "", e = 0; e < a.length; e++)if (c = a[e].split("="), j = c[0].replace(/^\s+|\s+$/g, ""), j == b)return 1 < c.length && (f = unescape(c[1].replace(/^\s+|\s+$/g, ""))), f;
            return null
...
Spotify = function (c) {
    c.RegistrationModule = new function () {
        ...
        var b, a = "download", d = "REGMODULE_OTHER", j = !1, f = null, e = null, g = null, h = null;
        ...
        this.onFbConnect = function (b) {
            ...
            if (F(e))this.useWebPlayer() ? (Spotify.Actions.WebPlayer.TokenControl.set(this.getSignupByEmailToken()), this.Tracking.send(e.Tracking.OPEN_WEBPLAYER), this.popupManager.show(c.PopupInfo.OPEN_WEBPLAYER.id)) :
                (this.Tracking.send(this.Tracking.DOWNLOAD_SIGNUP_EMAIL_SEC), this.popupManager.show(c.PopupInfo.DOWNLOAD.id)); else {
                var g = this;
                switch (h.getStatus()) {
                    case c.FbStatus.CONNECTED:
                        if (this.useWebPlayer())if (b)this.Tracking.send(e.Tracking.ALREADY_HAVE_SPOTIFY), this.popupManager.show(c.PopupInfo.ALREADY.id); else {
                            var j = h.getAuthResponse(), b = {
                                fb: j.accessToken,
                                id: j.userID,
                                creation_flow: a,
                                creation_point: d,
        ...
        this.init = function (g) {
            ...
            if ("undefined" === typeof this.parameters.notifyBridge)this.parameters.notifyBridge = !1; else if (g = localStorage.getItem("last-active-trackset"))g = JSON.parse(g), "tracks"in
            ...
            countryAvailable ? (h = new c.Fb, h.connect({appId: c.Config.get("fb-app-id")}, function () {
                i.onFbConnect(true)
        ...
        this.redirectToFacebookCheck = function () {
            h || (h = new c.Fb);
            var a = this.getUrl(void 0, !0), b = this.getUrl("cancel", !0), a = h.getConnectURL(a, b);
            window.location = a
        };
        ...
        this.playContext = function (a) {
            "undefined" !== typeof this.parameters.uri && e.check({
                token: b,
        ...
        var E = function (a) {
            ...
            var b = !1;
            -1 < window.location.hash.indexOf("emailAuth") && (b = window.location.hash.replace("#emailAuth=", ""), a.setSignupByEmailToken(b), b = !0);
            return b
        }
    };
    return c
...
(function (c, b) {
    function a(a, b) {
        var c, d, b = b || {}, a = "raven" + a.substr(0, 1).toUpperCase() + a.substr(1);
    ...
    function h(a, b) {
        var c, d;
        if (f(a.length))for (c in a)a.hasOwnProperty(c) && b.call(null, c, a[c]); else if (d = a.length)for (c = 0; c < d; c++)b.call(null, c, a[c])
    }
    ...
    function i(b, c) {
        ...
        b.stack && b.stack.length && h(b.stack, function (a, b) {
            ...
            if (b.url) {
                c = {
                    filename: b.url,
                    lineno: b.line, colno: b.column, "function": b.func || "?"
                };
                var e;
                if (b.context && k.fetchContext) {
                    e = b.context;
                    for (var p = ~~(e.length / 2), g = e.length, X = !1; g--;)if (300 < e[g].length) {
                        X = !0;
                        break
                    }
                    e = X ? f(b.column) ? void 0 : [[], e[p].substr(b.column, 50), []] : [e.slice(0, p), e[p], e.slice(p + 1)]
                } else e = void 0;
                if (e) {
        ...
        a("handle", {stackInfo: b, options: c});
        m(b.name, b.message, b.url, b.lineno, d, c)
    }

    function m(a, b, c, d, e, f) {
        var g, b = b + "";
        "Error" === a && !b || k.ignoreErrors.test(b) || (e && e.length ? (c = e[0].filename || c, e.reverse(), g = {frames: e}) : c && (g = {
            frames: [{
                filename: c,
                lineno: d,
                in_app: !0
            ...
            exception: {
                type: a,
                value: b
            }, stacktrace: g, culprit: c, message: d ? b + " at " + d : b
        }, f)))
    }
    ...
    function E(a) {
        if (F()) {
            var b = x, c = H, d = k.logger, f = k.site, h = {
                url: document.location.href,
                headers: {"User-Agent": navigator.userAgent}
            };
            document.referrer && (h.headers.Referer = document.referrer);
            a = b({project: c, logger: d, site: f, platform: "javascript", request: h}, a);
    ...
    function J(b) {
        var c = new Image, d = s + R + "&sentry_data=" + encodeURIComponent(JSON.stringify(b));
        c.onload = function () {
            a("success", {data: b, src: d})
        };
        c.onerror = c.onabort = function () {
            a("failure", {data: b, src: d})
        };
        c.src = d
    }
    ...
    var n = {remoteFetching: !1, collectWindowErrors: !0, linesOfContext: 7}, L = [].slice, G = "?";
    n.wrap = function (a) {
        return function () {
            try {
    ...
    n.report = function () {
        function a(b, c) {
            ...
            if (!c || n.collectWindowErrors) {
                for (var e in g)if (Object.prototype.hasOwnProperty.call(g,
                        e))try {
        ...
        var g = [], h = null, k = null, j = null, i, m;
    ...
    n.computeStackTrace = function () {
        function a(b) {
            ...
            if (!Object.prototype.hasOwnProperty.call(s, b)) {
                var d = "";
                if (-1 !== b.indexOf(document.domain))if (n.remoteFetching)try {
                    var e;
                    try {
        ...
        function b(c, d) {
            var e = /function ([^(]*)\(([^)]*)\)/, g = /['"]?([0-9A-Za-z$_]+)['"]?\s*[:=]\s*(function|eval|new Function)/, h = "", j = a(c), k;
            if (!j.length)return G;
            for (var i = 0; 10 > i; ++i)if (h =
        ...
        function h(b, c) {
            for (var d, e, f = 0, g = c.length; f < g; ++f)if ((d = a(c[f])).length)if (d = d.join("\n"), e = b.exec(d))return {
                url: c[f],
        ...
        function j(b, c, d) {
            var c = a(c), b = RegExp("\\b" + e(b) + "\\b"), f, d = d - 1;
            return c && c.length > d && (f = b.exec(c[d])) ? f.index : null
        }

        function k(a) {
            var b = [c.location.href], d = document.getElementsByTagName("script"), a = "" + a, f;
            ...
            if (f = h(d, b))return f;
            if (d = /^function on([\w$]+)\s*\(event\)\s*\{\s*(\S[\s\S]*\S)\s*\}\s*$/.exec(a))if (a = d[1], d = g(d[2]), (f = h(RegExp("on" + a + "=[\\'\"]\\s*" + d + "\\s*[\\'\"]", "i"), b[0])) || (f = h(RegExp(d), b)))return f;
            return null
        }
        ...
        function m(a, c) {
            for (var d = /function\s+([_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)?\s*\(/i, e = [], f = {}, g = !1, h, p, z = m.caller; z && !g; z = z.caller)if (!(z ===
                o || z === n.report)) {
                p = {url: null, func: G, line: null, column: null};
                if (z.name)p.func = z.name; else if (h = d.exec(z.toString()))p.func = h[1];
                if (h = k(z)) {
                    p.url = h.url;
                    p.line = h.line;
            ...
            c && e.splice(0, c);
            d = {name: a.name, message: a.message, url: document.location.href, stack: e};
        ...
        function o(e,
            ...
            try {
                ...
                if (i = !u.length ? null : {
                        name: e.name, message: e.message, url: document.location.href,
                        stack: u
                    })return i
            } catch (F) {
                if (x)throw F;
            ...
            try {
                if (e.stack) {
                    var n = /^\s*at (?:((?:\[object object\])?\S+(?: \[as \S+\])?) )?\(?((?:file|https?):.*?):(\d+)(?::(\d+))?\)?\s*$/i, s = /^\s*(\S*)(?:\((.*?)\))?@((?:file|https?).*?):(\d+)(?::(\d+))?\s*$/i, P = e.stack.split("\n"), u = [], r, v, I = /^(.*) is undefined$/.exec(e.message);
                    y = 0;
            ...
            try {
                ...
                if (4 > C.length)i = null; else {
                    ...
                    var I = [], q = document.getElementsByTagName("script"), S = [], B, w, H, D;
                    for (w in q)Object.prototype.hasOwnProperty.call(q, w) && !q[w].src && S.push(q[w]);
                    w = 2;
                    for (H = C.length; w < H; w += 2) {
                        q = null;
                        if (B = P.exec(C[w]))q = {url: B[2], func: B[3], line: +B[1]}; else if (B = r.exec(C[w])) {
                            var q = {url: B[3], func: B[4]}, N = +B[1], L = S[B[2] - 1];
                            if (L && (D = a(q.url))) {
                                D = D.join("\n");
                            ...
                            var O = c.location.href.replace(/#.*$/, ""), R = B[1], T = RegExp(g(C[w + 1]));
                            D = h(T, [O]);
                            q = {url: O, line: D ? D.line : R, func: ""}
                        }
                        if (q) {
                            q.func || (q.func = b(q.url, q.line));
                            var Q = d(q.url, q.line), U = Q ? Q[Math.floor(Q.length / 2)] : null;
                            q.context = Q && U.replace(/^\s*/, "") === C[w + 1].replace(/^\s*/, "") ? Q : [C[w + 1]];
                            I.push(q)
                        }
                    }
                    i = !I.length ? null : {name: e.name, message: C[0], url: document.location.href, stack: I}
                }
                if (i)return i
            } catch (V) {
                if (x)throw V;
    ...
    "use strict";
    var da = c.Raven, ca = !(!c.JSON || !c.JSON.stringify), T, O, s, N, U, H, k = {
            logger: "javascript",
            ignoreErrors: [],
            ignoreUrls: [],
            whitelistUrls: [],
            ...
            VERSION: "1.1.15", noConflict: function () {
                ...
                return o
                                 ...
                                 b) {
                if (!a)return o;
                var c = j(a), d = c.path.lastIndexOf("/"), e = c.path.substr(1, d);
                b && h(b, function (a, b) {
                    k[a] = b
                });
        ...
        ba = "source,protocol,user,pass,host,port,path".split(","), W = /^(?:(\w+):)?\/\/(\w+)(:\w+)?@([\w\.-]+)(?::(\d+))?(\/.*)/;
    d.prototype = Error();
